...
field17 = fieldObject().setName("vertex").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFSTRING).setValue("\"gl_flowers_chromatic.vs\"")
ExternProtoDeclare16.addField(field17)
field18 = fieldObject().setName("fragment").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFSTRING).setValue("\"pc_flowers.fs\"")
...
fieldValue23 = fieldValueObject().setName("vertex").setValue("\"cobweb_flowers_plain.vs\"")
ProtoInstance22.addFieldValue(fieldValue23)
fieldValue24 = fieldValueObject().setName("fragment").setValue("\"plain.fs\"")
