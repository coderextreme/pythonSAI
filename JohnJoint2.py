...
HAnimJoint33.center = [0.0000,0.9149,0.0016]
...
HAnimJoint35.center = [0.1040,0.4867,0.0308]
...
HAnimJoint62.center = [-0.0950,0.9171,0.0029]
...
HAnimJoint93.center = [0.0045,1.1546,-0.0800]
...
HAnimJoint96.center = [0.0053,1.2679,-0.0810]
...
HAnimJoint109.center = [0.0066,1.5520,-0.0082]
...
HAnimJoint111.center = [0.0066,1.5800,-0.0103]
...
HAnimJoint122.center = [0.0820,1.4488,-0.0353]
...
HAnimJoint150.center = [-0.0694,1.4600,-0.0330]
...
HAnimJoint153.center = [-0.1949,1.1388,-0.0620]
...
HAnimJoint158.center = [-0.1864,0.8190,0.0506]
...
HAnimJoint165.center = [-0.1972,0.8060,-0.0468]
...
HAnimJoint167.center = [-0.1950,0.7304,-0.0441]
...
HAnimJoint172.center = [-0.1920,0.7318,-0.0716]
...
HAnimJoint177.center = [-0.1908,0.7540,-0.0960]
...
X3D0.Scene = Scene11
f = open("JohnJoint2_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
