...
head1.addMeta(meta5)
meta6 = metaObject().setName("revised").setContent("23 January 2005")
head1.addMeta(meta6)
...
head1.addMeta(meta9)
meta10 = metaObject().setName("translated").setContent("06 May 2017")
...
meta13 = metaObject().setName("translated").setContent("6 May 2017")
...
field35 = fieldObject().setName("set_fraction").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFFLOAT)
Script34.addField(field35)
field36 = fieldObject().setName("coordinates").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFVEC3F)
Script34.addField(field36)
field37 = fieldObject().setName("coordIndexes").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFINT32)
...
field39 = fieldObject().setName("set_fraction").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFFLOAT)
Script38.addField(field39)
field40 = fieldObject().setName("coordinates").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFVEC3F)
Script38.addField(field40)
field41 = fieldObject().setName("coordIndexes").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFINT32)
