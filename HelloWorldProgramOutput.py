...
unit10.setConversionFactor(1.0)
...
TimeSensor55.setCycleInterval(8.0)
...
TimeSensor71.setCycleInterval(5.0)
...
TimeSensor80.setCycleInterval(60.0)
...
Material152.setTransparency(1.0)
