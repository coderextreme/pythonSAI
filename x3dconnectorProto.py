...
field60 = fieldObject().setName("startnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
ProtoInterface59.addField(field60)
field61 = fieldObject().setName("endnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
ProtoInterface59.addField(field61)
field62 = fieldObject().setName("connectornode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
ProtoInterface59.addField(field62)
field63 = fieldObject().setName("set_startpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
ProtoInterface59.addField(field63)
field64 = fieldObject().setName("set_endpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
...
field67 = fieldObject().setName("startnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
Script66.addField(field67)
field68 = fieldObject().setName("endnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
Script66.addField(field68)
field69 = fieldObject().setName("connectornode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
Script66.addField(field69)
field70 = fieldObject().setName("set_startpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script66.addField(field70)
field71 = fieldObject().setName("set_endpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
