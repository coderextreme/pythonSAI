...
PlaneSensor29 = x3dpsail.PlaneSensor()
...
fieldValue86 = x3dpsail.fieldValue()
...
Transform98 = x3dpsail.Transform()
...
Transform105 = x3dpsail.Transform()
...
X3D0.toFileX3D("././x3dconnectorProto_RoundTrip.x3d")
