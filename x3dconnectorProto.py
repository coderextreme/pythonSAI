...
Transform17.setTranslation([1,-1,.01])
Shape18 = x3d.Shape()
...
PlaneSensor22.setOffset([1,-1,.01])
...
Transform24.setTranslation([1,1,.01])
Shape25 = x3d.Shape()
...
PlaneSensor29.setOffset([1,1,.01])
...
Transform31.setTranslation([-1,1,.01])
Shape32 = x3d.Shape()
...
PlaneSensor36.setOffset([-1,1,.01])
