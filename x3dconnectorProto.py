...
Background11.skyColor = [0.4,0.4,0.4]
...
Transform19.DEF = "G2"
Transform19.translation = [1,-1,0.01]
Shape20 = x3d.Shape()
...
Transform26.DEF = "G3"
Transform26.translation = [1,1,0.01]
Shape27 = x3d.Shape()
...
Transform33.DEF = "G4"
Transform33.translation = [-1,1,0.01]
Shape34 = x3d.Shape()
...
X3D0.Scene = Scene8
f = open("././x3dconnectorProto_RoundTrip.x3d", "w")
f.write(X3D0.XML())
f.close()
