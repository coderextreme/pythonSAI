...
ProtoInstance80 = ProtoInstanceObject().setName("x3dconnector").setDEF("connector2")
fieldValue81 = fieldValueObject().setName("startnode")
Transform82 = TransformObject().setUSE("G1")
fieldValue81.addChild(Transform82)
ProtoInstance80.addFieldValue(fieldValue81)
fieldValue83 = fieldValueObject().setName("endnode")
Transform84 = TransformObject().setUSE("G3")
fieldValue83.addChild(Transform84)
ProtoInstance80.addFieldValue(fieldValue83)
fieldValue85 = fieldValueObject().setName("connectornode")
Transform86 = TransformObject().setUSE("C2")
fieldValue85.addChild(Transform86)
ProtoInstance80.addFieldValue(fieldValue85)
Scene7.addChild(ProtoInstance80)
ProtoInstance87 = ProtoInstanceObject().setName("x3dconnector").setDEF("connector3")
...
Transform91 = TransformObject().setUSE("G4")
...
Transform93 = TransformObject().setUSE("C3")
fieldValue92.addChild(Transform93)
ProtoInstance87.addFieldValue(fieldValue92)
Scene7.addChild(ProtoInstance87)
ROUTE94 = ROUTEObject().setFromNode("G1").setFromField("translation_changed").setToNode("connector1").setToField("set_startpoint")
Scene7.addChild(ROUTE94)
ROUTE95 = ROUTEObject().setFromNode("G2").setFromField("translation_changed").setToNode("connector1").setToField("set_endpoint")
Scene7.addChild(ROUTE95)
ROUTE96 = ROUTEObject().setFromNode("G1").setFromField("translation_changed").setToNode("connector2").setToField("set_startpoint")
Scene7.addChild(ROUTE96)
ROUTE97 = ROUTEObject().setFromNode("G3").setFromField("translation_changed").setToNode("connector2").setToField("set_endpoint")
Scene7.addChild(ROUTE97)
ROUTE98 = ROUTEObject().setFromNode("G1").setFromField("translation_changed").setToNode("connector3").setToField("set_startpoint")
Scene7.addChild(ROUTE98)
ROUTE99 = ROUTEObject().setFromNode("G4").setFromField("translation_changed").setToNode("connector3").setToField("set_endpoint")
