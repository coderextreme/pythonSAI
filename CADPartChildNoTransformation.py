...
IndexedTriangleSet32.ccw = True
IndexedTriangleSet32.colorPerVertex = True
...
IndexedTriangleSet32.normalPerVertex = True
IndexedTriangleSet32.solid = True
...
IndexedTriangleSet37.ccw = True
IndexedTriangleSet37.colorPerVertex = True
...
IndexedTriangleSet37.normalPerVertex = True
IndexedTriangleSet37.solid = True
...
X3D0.Scene = Scene15
f = open("CADPartChildNoTransformation_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
