...
head1.addMeta(meta5)
meta6 = metaObject().setName("revised").setContent("2 Dec 2015")
head1.addMeta(meta6)
...
field66 = fieldObject().setName("set_rightstring").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFSTRING)
Script65.addField(field66)
field67 = fieldObject().setName("rightlines").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFSTRING)
...
field69 = fieldObject().setName("set_upstring").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFSTRING)
Script68.addField(field69)
field70 = fieldObject().setName("uplines").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFSTRING)
...
field72 = fieldObject().setName("set_centerstring").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFSTRING)
Script71.addField(field72)
field73 = fieldObject().setName("centerlines").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFSTRING)
