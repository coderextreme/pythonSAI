...
TimeSensor51.cycleInterval = 8.0
...
if MetadataSet59.value is None:
    MetadataSet59.value = []
...
TimeSensor67.cycleInterval = 5.0
...
TimeSensor76.cycleInterval = 60.0
...
ProtoInstance94.material = fieldValue95
...
ProtoInstance99.material = fieldValue100
...
X3D0.Scene = Scene29
f = open("Quotes_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
