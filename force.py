...
head1.addMeta(meta7)
meta8 = metaObject().setName("translated").setContent("06 May 2017")
head1.addMeta(meta8)
...
meta11 = metaObject().setName("translated").setContent("6 May 2017")
...
field16 = fieldObject().setName("position").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
...
field33 = fieldObject().setName("translation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("50 50 0")
Script32.addField(field33)
field34 = fieldObject().setName("old").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
Script32.addField(field34)
field35 = fieldObject().setName("set_cycle").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFTIME)
Script32.addField(field35)
field36 = fieldObject().setName("keyValue").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFVEC3F)
...
field44 = fieldObject().setName("positionA").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
ProtoInterface43.addField(field44)
field45 = fieldObject().setName("positionB").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
...
field52 = fieldObject().setName("spine").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFVEC3F).setValue("0 -50 0 0 50 0")
Script51.addField(field52)
field53 = fieldObject().setName("set_endA").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script51.addField(field53)
field54 = fieldObject().setName("set_endB").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script51.addField(field54)
IS55 = ISObject()
connect56 = connectObject().setNodeField("set_endA").setProtoField("positionA")
IS55.addConnect(connect56)
connect57 = connectObject().setNodeField("set_endB").setProtoField("positionB")
...
fieldValue70 = fieldValueObject().setName("positionA").setValue("0 0 0")
ProtoInstance69.addFieldValue(fieldValue70)
fieldValue71 = fieldValueObject().setName("positionB").setValue("50 50 50")
...
fieldValue73 = fieldValueObject().setName("positionA").setValue("0 0 0")
ProtoInstance72.addFieldValue(fieldValue73)
fieldValue74 = fieldValueObject().setName("positionB").setValue("-50 -50 -50")
...
fieldValue76 = fieldValueObject().setName("positionA").setValue("50 50 50")
ProtoInstance75.addFieldValue(fieldValue76)
fieldValue77 = fieldValueObject().setName("positionB").setValue("50 50 -50")
...
field79 = fieldObject().setName("counter").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("0").setType(fieldObject.TYPE_SFINT32)
Script78.addField(field79)
field80 = fieldObject().setName("node_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFNODE)
Script78.addField(field80)
field81 = fieldObject().setName("add_node").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0").setType(fieldObject.TYPE_SFBOOL)
Script78.addField(field81)
field82 = fieldObject().setName("ModifiableNode").setType(fieldObject.TYPE_SFNODE).setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)
...
ROUTE85 = ROUTEObject().setFromNode("nodeA").setFromField("position").setToNode("linkA").setToField("positionA")
Scene13.addChild(ROUTE85)
ROUTE86 = ROUTEObject().setFromNode("nodeB").setFromField("position").setToNode("linkA").setToField("positionB")
Scene13.addChild(ROUTE86)
ROUTE87 = ROUTEObject().setFromNode("nodeA").setFromField("position").setToNode("linkB").setToField("positionA")
Scene13.addChild(ROUTE87)
ROUTE88 = ROUTEObject().setFromNode("nodeC").setFromField("position").setToNode("linkB").setToField("positionB")
Scene13.addChild(ROUTE88)
ROUTE89 = ROUTEObject().setFromNode("nodeA").setFromField("position").setToNode("linkC").setToField("positionA")
Scene13.addChild(ROUTE89)
ROUTE90 = ROUTEObject().setFromNode("nodeD").setFromField("position").setToNode("linkC").setToField("positionB")
