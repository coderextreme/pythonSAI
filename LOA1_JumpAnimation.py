...
PositionInterpolator58.key = [0.0,0.04,0.08,0.12,0.16,0.2,0.24,0.28,0.32,0.36,0.4,0.44,0.48,0.64,0.76,0.8,0.84,0.88,0.92,0.96,1.0]
IS59 = x3d.IS()
...
OrientationInterpolator61.key = [0.0,0.28,0.32,0.48,0.64,0.76,1.0]
IS62 = x3d.IS()
...
OrientationInterpolator64.key = [0.0,0.28,0.32,0.48,0.76,1.0]
IS65 = x3d.IS()
...
OrientationInterpolator67.key = [0.0,0.28,0.32,0.36,0.4,0.44,0.48,0.64,0.76,0.88,1.0]
IS68 = x3d.IS()
...
OrientationInterpolator70.key = [0.0,0.28,0.32,0.48,0.64,0.76,0.88,1.0]
IS71 = x3d.IS()
...
OrientationInterpolator73.key = [0.0,0.28,0.32,0.36,0.4,0.44,0.48,0.64,0.76,0.84,0.88,0.92,0.96,1.0]
IS74 = x3d.IS()
...
OrientationInterpolator79.key = [0.0,0.28,0.32,0.36,0.4,0.44,0.48,0.64,0.76,0.88,1.0]
IS80 = x3d.IS()
...
OrientationInterpolator82.key = [0.0,0.28,0.32,0.48,0.64,0.76,0.88,1.0]
IS83 = x3d.IS()
...
OrientationInterpolator85.key = [0.0,0.28,0.32,0.36,0.4,0.44,0.48,0.64,0.76,0.84,0.88,0.92,0.96,1.0]
IS86 = x3d.IS()
...
OrientationInterpolator94.key = [0.0,0.28,0.32,0.48,0.76,1.0]
IS95 = x3d.IS()
...
OrientationInterpolator97.key = [0.0,0.28,0.32,0.64,0.76,0.88,1.0]
IS98 = x3d.IS()
...
OrientationInterpolator100.key = [0.0,0.28,0.32,0.64,0.76,1.0]
IS101 = x3d.IS()
...
OrientationInterpolator103.key = [0.0,0.28,0.32,0.64,0.76,0.88,1.0]
IS104 = x3d.IS()
...
OrientationInterpolator106.key = [0.0,0.28,0.32,0.64,0.76,0.88,1.0]
IS107 = x3d.IS()
...
OrientationInterpolator109.key = [0.0,0.28,0.32,0.64,0.76,1.0]
IS110 = x3d.IS()
...
OrientationInterpolator112.key = [0.0,0.28,0.32,0.64,0.76,1.0]
IS113 = x3d.IS()
...
X3D0.Scene = Scene17
f = open("LOA1_JumpAnimation_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
