...
X3D0 = (x3dpsail.X3D().setProfile(x3dpsail.SFString("Immersive")).setVersion(x3dpsail.SFString("3.3"))
      ...
      .setScene(x3dpsail.Scene()
        ...
        .addChild(x3dpsail.Group()
          .addChild(x3dpsail.ExternProtoDeclare().setName(x3dpsail.SFString("FlowerProto")).setUrl(x3dpsail.MFString(["../data/flowerproto.json#FlowerProto"]))
            ...
            .setProtoBody(x3dpsail.ProtoBody()
              .addChild(x3dpsail.Group()
                .addChild(x3dpsail.ProtoInstance().setName(x3dpsail.SFString("FlowerProto"))
                  .addFieldValue(x3dpsail.fieldValue().setName(x3dpsail.SFString("vertex")).setValue(x3dpsail.SFString("\"../shaders/x3dom_flowers_chromatic.vs\"")))
...
X3D0.toFileX3D("./future/./x3domflowers_RoundTrip.x3d")
