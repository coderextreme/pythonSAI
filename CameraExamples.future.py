...
#TimeSensor animates the CameraClock since that maintains the computed PositionInterpolator and OrientationInterpolator
     ...
     .addChildren(TransformObject() \
      ...
      .addChildren(BooleanFilterObject() \
...
#Simplify intersection test for user selecting text
      .addChildren(ShapeObject() \
       ...
       .setGeometry(BoxObject(size = [6,2,0.0001]) \
       ) \
      ) \
     ) \
    ) \
...
#move CameraShape using active Camera
     ...
     .addChildren(TransformObject() \
      ...
      .addChildren(ShapeObject() \
       .setDEF("SightLine") \
       .setGeometry(IndexedLineSetObject(coordIndex = [0,1]) \
...
#Display frustum to show camera view within the scene, toggled by user selecting CameraShape
     ...
     .addChildren(BooleanToggleObject() \
...
#=============== add checkerboard, axes and other things to look at while animating ==============
    ...
    .addChildren(TransformObject() \
     ...
     .addChildren(ShapeObject() \
      ...
      .setGeometry(IndexedFaceSetObject(colorPerVertex = False, coordIndex = [0,8,9,1,-1,1,9,10,2,-1,2,10,11,3,-1,3,11,12,4,-1,4,12,13,5,-1,5,13,14,6,-1,6,14,15,7,-1,8,16,17,9,-1,9,17,18,10,-1,10,18,19,11,-1,11,19,20,12,-1,12,20,21,13,-1,13,21,22,14,-1,14,22,23,15,-1,16,24,25,17,-1,17,25,26,18,-1,18,26,27,19,-1,19,27,28,20,-1,20,28,29,21,-1,21,29,30,22,-1,22,30,31,23,-1,24,32,33,25,-1,25,33,34,26,-1,26,34,35,27,-1,27,35,36,28,-1,28,36,37,29,-1,29,37,38,30,-1,30,38,39,31,-1,32,40,41,33,-1,33,41,42,34,-1,34,42,43,35,-1,35,43,44,36,-1,36,44,45,37,-1,37,45,46,38,-1,38,46,47,39,-1,40,48,49,41,-1,41,49,50,42,-1,42,50,51,43,-1,43,51,52,44,-1,44,52,53,45,-1,45,53,54,46,-1,46,54,55,47,-1,48,56,57,49,-1,49,57,58,50,-1,50,58,59,51,-1,51,59,60,52,-1,52,60,61,53,-1,53,61,62,54,-1,54,62,63,55,-1], normalPerVertex = False, solid = False) \
     ...
     .addChildren(TransformObject() \
      ...
      .addChildren(ShapeObject() \
       .setGeometry(TextObject() \
        ...
        .setFontStyle(FontStyleObject(justify = ["MIDDLE","MIDDLE"], size = 0.5) \
        ) \
       ) \
       .setAppearance(AppearanceObject() \
        .setMaterial(MaterialObject() \
