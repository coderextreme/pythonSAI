...
head1.addMeta(meta8)
meta9 = metaObject().setName("translated").setContent("06 May 2017")
head1.addMeta(meta9)
...
meta12 = metaObject().setName("translated").setContent("6 May 2017")
...
field17 = fieldObject().setName("position").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
...
field28 = fieldObject().setName("translation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("50 50 0")
Script27.addField(field28)
field29 = fieldObject().setName("old").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
Script27.addField(field29)
field30 = fieldObject().setName("set_cycle").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFTIME)
Script27.addField(field30)
field31 = fieldObject().setName("keyValue").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFVEC3F)
...
field39 = fieldObject().setName("positionA").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
ProtoInterface38.addField(field39)
field40 = fieldObject().setName("positionB").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
...
field47 = fieldObject().setName("spine").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFVEC3F).setValue("0 -50 0 0 0 0 0 50 0")
Script46.addField(field47)
field48 = fieldObject().setName("set_endA").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script46.addField(field48)
field49 = fieldObject().setName("set_endB").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
