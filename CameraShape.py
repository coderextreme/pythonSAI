...
Viewpoint17.setOrientation([0,1,0,1.5708])
Viewpoint17.setPosition([12,0,-4])

Scene13.addChildren(Viewpoint17)
Viewpoint18 = x3dpsail.Viewpoint()
Viewpoint18.setDescription("Camera view from above")
Viewpoint18.setOrientation([1,0,0,-1.5708])
Viewpoint18.setPosition([0,15,-5])

Scene13.addChildren(Viewpoint18)
Viewpoint19 = x3dpsail.Viewpoint()
Viewpoint19.setDescription("Camera view from left side")
Viewpoint19.setOrientation([0,1,0,-1.5708])
Viewpoint19.setPosition([-12,0,-4])

Scene13.addChildren(Viewpoint19)
Transform20 = x3dpsail.Transform()
Transform20.setScale([0.1,0.1,0.1])
Transform20.setTranslation([0,-0.165,0.02])
Switch21 = x3dpsail.Switch()
...
IndexedFaceSet26 = x3dpsail.IndexedFaceSet()
...
Coordinate27 = x3dpsail.Coordinate()
Coordinate27.setDEF("pCylinder1GeoPoints")
Coordinate27.setPoint([-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31])
...
IndexedFaceSet30 = x3dpsail.IndexedFaceSet()
...
Coordinate31 = x3dpsail.Coordinate()
...
IndexedFaceSet38 = x3dpsail.IndexedFaceSet()
...
Group41 = x3dpsail.Group()
Transform42 = x3dpsail.Transform()
Transform42.setDEF("pCylinder1")
Transform42.setRotation([-1,0,0,0.373518])
Transform42.setTranslation([-0.038462,3.596312,3.297562])
...
IndexedFaceSet45 = x3dpsail.IndexedFaceSet()
...
Transform46.setScale([1,0.727134,0.801457])
Transform46.setTranslation([-0.030769,1.738461,1.4436])
...
IndexedFaceSet49 = x3dpsail.IndexedFaceSet()
...
Transform50.setScale([1,1,0.569444])
Transform50.setTranslation([0.015385,1.630769,-1.973274])
...
Transform54.setScale([1.1,1.1,0.1])
Transform54.setTranslation([-0.015385,1.628515,-2.569231])
...
IndexedFaceSet57 = x3dpsail.IndexedFaceSet()
...
Scene13.addChildren(Transform20)

X3D0.setScene(Scene13)
X3D0.toFileX3D("././CameraShape_RoundTrip.x3d")
