...
meta28 = metaObject().setName("translated").setContent("06 May 2017")
...
meta31 = metaObject().setName("translated").setContent("6 May 2017")
...
field50 = fieldObject().setName("index").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("index for active strategy card, -1 means no selection").setType(fieldObject.TYPE_SFINT32).setValue("0")
Script49.addField(field50)
field51 = fieldObject().setName("string_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("latest strategy card value").setType(fieldObject.TYPE_MFSTRING)
Script49.addField(field51)
field52 = fieldObject().setName("textToSpeechUrl").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("url to invoke Google Translate").setType(fieldObject.TYPE_MFSTRING)
Script49.addField(field52)
field53 = fieldObject().setName("newCardTime").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("activate Sound node").setType(fieldObject.TYPE_SFTIME)
Script49.addField(field53)
field54 = fieldObject().setName("selectPreviousCard").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL)
Script49.addField(field54)
field55 = fieldObject().setName("selectNextCard").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL)
Script49.addField(field55)
field56 = fieldObject().setName("selectRandomCard").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL)
Script49.addField(field56)
field57 = fieldObject().setName("traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("controls console tracing").setType(fieldObject.TYPE_SFBOOL).setValue("true")
