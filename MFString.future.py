...
X3D0 = X3DObject() \
   ...
   .setHead(headObject() \
    ...
    .addMeta(metaObject() \
     .setName("description") \
     .setContent("F-16, The Fighting Falcon, Turkish Air Force (TUAF), Turkey") \
    ) \
    .addMeta(metaObject() \
     .setName("creator") \
     .setContent("Murat ONDER, LTJG, Turkish Navy") \
    ) \
    .addMeta(metaObject() \
     .setName("creator") \
     .setContent("The coordinates of the main body (Except landing gears, nose antenna, flag, weapons, missile holders, cockpit, cockpit seat and fuel tanks) are mostly similar to the model of Soji Yamakawa and used with permission.") \
    ) \
    .addMeta(metaObject() \
     .setName("created") \
     .setContent("13 July 2003") \
    ) \
    .addMeta(metaObject() \
     .setName("modified") \
    ...
    .addMeta(metaObject() \
     .setName("reference") \
     .setContent("http://www.fas.org/man/dod-101/sys/ac/f-16.htm") \
    ) \
    .addMeta(metaObject() \
     .setName("permission") \
    ...
    .addMeta(metaObject() \
     .setName("reference") \
     .setContent("The landing gears are taken from the Savage Archive, from F18 Blue Angel, then modified and re-animated.") \
    ) \
    .addMeta(metaObject() \
     .setName("drawing") \
     .setContent("\"Drawing.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\"") \
    ) \
    .addMeta(metaObject() \
     .setName("Image") \
    ...
    .addMeta(metaObject() \
     .setName("identifier") \
     .setContent("https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/F16.x3d") \
    ) \
    .addMeta(metaObject() \
     .setName("subject") \
     .setContent("F16, F-16, Fighting Falcon") \
    ) \
    .addMeta(metaObject() \
     .setName("generator") \
   ...
   .setScene(SceneObject() \
    .addChildren(TransformObject() \
     ...
     .addChildren(TransformObject() \
      ...
      .addChildren(ShapeObject() \
       .setDEF("ExhaustExitFlatPanel") \
       .setAppearance(AppearanceObject() \
        .setMaterial(MaterialObject() \
         .setDiffuseColor([0.5,0.5,0.5]) \
        ) \
       ) \
       .setGeometry(IndexedFaceSetObject(coordIndex = [186,187,188,189,190,-1,190,191,192,193,186,-1], creaseAngle = 0.5, normalIndex = [118,119,120,121,122,-1,122,123,124,125,118,-1], solid = False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
        .setNormal(NormalObject() \
      ...
      .addChildren(ShapeObject() \
       .setDEF("ExhaustEntranceFrontBottomPart") \
       .setAppearance(AppearanceObject() \
        .setMaterial(MaterialObject() \
         .setDiffuseColor([0.2304,0.2304,0.2304]) \
        ) \
       ) \
       .setGeometry(IndexedFaceSetObject(coordIndex = [194,130,173,195,196,197,-1,197,198,199,82,81,194,-1], creaseAngle = 0.5, normalIndex = [126,126,126,126,126,126,-1,126,126,126,126,126,126,-1], solid = False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
        .setNormal(NormalObject() \
      ...
      .addChildren(ShapeObject() \
       .setDEF("ThirdPartFromNoseUnderCanopy") \
       .setAppearance(AppearanceObject() \
        .setMaterial(MaterialObject() \
         .setDiffuseColor([0.6,0.6,0.6]) \
        ) \
       ) \
       .setGeometry(IndexedFaceSetObject(coordIndex = [12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1], creaseAngle = 0.5, normalIndex = [8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1], solid = False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
        .setNormal(NormalObject() \
      ...
      .addChildren(ShapeObject() \
       .setDEF("SecondPartAfterNose") \
       .setAppearance(AppearanceObject() \
        .setMaterial(MaterialObject() \
         .setDiffuseColor([0.6,0.6,0.6]) \
        ) \
       ) \
       .setGeometry(IndexedFaceSetObject(coordIndex = [0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1], creaseAngle = 0.5, normalIndex = [0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1], solid = False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
        .setNormal(NormalObject() \
     ...
     .addChildren(TransformObject() \
      .setDEF("CockpitTransform") \
      .setRotation([1,0,0,-0.1]) \
      .setScale([0.045,0.045,0.045]) \
      .setTranslation([0,1,-10]) \
      .addChildren(InlineObject() \
       .setUrl(["Cockpit.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.x3d","Cockpit.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.wrl"]) \
      ) \
     ) \
     .addChildren(TransformObject() \
      .setDEF("SeatTransform") \
      .setRotation([-1,0,0,-0.1]) \
      .setScale([0.9,0.9,0.9]) \
      .setTranslation([0,0,-8.3]) \
      .addChildren(InlineObject() \
       .setUrl(["Seat.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.x3d","Seat.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.wrl"]) \
      ) \
     ) \
     .addChildren(TransformObject() \
      .setDEF("FrontWheelTransform") \
      .setCenter([0,2.5,0]) \
...
#Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)
     ...
     .addChildren(TransformObject() \
      .setDEF("RearRightWheelTransform") \
      .setCenter([0,2.5,0]) \
      .setRotation([-1,0,-1,1.92]) \
      .setTranslation([2.95,-5,7]) \
#Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)
     ...
     .addChildren(TransformObject() \
      .setDEF("CockpitButtonsTransform") \
      .addChildren(TransformObject() \
       .setDEF("UpButtonTransform") \
       .setRotation([1,0,0,1.57]) \
       .setScale([0.008,0.008,0.008]) \
       .setTranslation([-0.95,1.05,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(CylinderObject(height = 1, radius = 4) \
        ) \
        .setAppearance(AppearanceObject() \
         .setMaterial(MaterialObject() \
       ...
       .addChildren(TouchSensorObject() \
        .setDEF("TouchSensorUp") \
        .setDescription("click for gears up") \
       ) \
      ) \
      .addChildren(TransformObject() \
       .setDEF("DownButtonTransform") \
       .setRotation([1,0,0,1.57]) \
       .setScale([0.008,0.008,0.008]) \
       .setTranslation([-0.83,1.05,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(CylinderObject(height = 1, radius = 4) \
        ) \
        .setAppearance(AppearanceObject() \
       ...
       .addChildren(TouchSensorObject() \
        .setDEF("TouchSensorDown") \
        .setDescription("click for gears down") \
       ) \
      ) \
      .addChildren(TransformObject() \
       .setDEF("GearUpTextTransform") \
       .setScale([0.06,0.06,0.06]) \
       .setTranslation([-0.65,1.55,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(TextObject() \
         .setString(["RED Button","Gear Up"]) \
        ) \
        .setAppearance(AppearanceObject() \
         .setMaterial(MaterialObject() \
          .setDiffuseColor([1,0,0]) \
      ...
      .addChildren(TransformObject() \
       .setDEF("GearDownTextTransform") \
       .setScale([0.06,0.06,0.06]) \
       .setTranslation([-0.65,1.35,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(TextObject() \
         .setLength([5.5]) \
         .setString(["YELLOW Button","Gear Down"]) \
        ) \
        .setAppearance(AppearanceObject() \
         .setMaterial(MaterialObject() \
          .setDiffuseColor([1,1,0]) \
      ...
      .addChildren(TransformObject() \
       .setDEF("FireButtonTransform") \
       .setRotation([1,0,0,1.57]) \
       .setScale([0.008,0.008,0.008]) \
       .setTranslation([0.52,1.6,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(CylinderObject(height = 1, radius = 4) \
        ) \
        .setAppearance(AppearanceObject() \
         .setMaterial(MaterialObject() \
          .setDiffuseColor([0,0.75,0.18]) \
          .setShininess(0.8) \
         ) \
        ) \
       ) \
       .addChildren(TouchSensorObject() \
        .setDEF("FireSensor") \
        .setDescription("click to fire") \
       ) \
      ) \
      .addChildren(TransformObject() \
       .setDEF("FireTextTransform") \
       .setScale([0.06,0.06,0.06]) \
       .setTranslation([0.36,1.5,-10]) \
       .addChildren(ShapeObject() \
        .setGeometry(TextObject() \
         .setString(["Target Locked"," FIRE!..","(Green Button)"]) \
        ) \
        .setAppearance(AppearanceObject() \
         .setMaterial(MaterialObject() \
          .setDiffuseColor([0,0.75,0.18]) \
     ...
     .addChildren(ViewpointObject() \
      .setDescription("F16 Close Look-up") \
      .setOrientation([-0.559,-0.827,-0.057,1.3534]) \
      .setPosition([-28.7,19.9,17.4]) \
     ) \
     .addChildren(ViewpointObject() \
      .setDescription("Cockpit") \
      .setOrientation([-1,0,0,0.1249]) \
      .setPosition([0,1.5,-7.9]) \
     ) \
     .addChildren(ViewpointObject() \
      .setDEF("LandingGearAnimationView") \
      .setDescription("Landing Gear Animation View") \
      .setOrientation([-0.003,1,-0.012,2.5741]) \
      .setPosition([16.1,-5.8,-24.6]) \
     ) \
     .addChildren(ViewpointObject() \
      .setDescription("Cockpit Left View") \
      .setOrientation([-0.276,-0.922,-0.271,1.2338]) \
      .setPosition([-6.7,6.1,-3.9]) \
     ) \
     .addChildren(ViewpointObject() \
      .setDescription("F-16 Front View") \
      .setOrientation([-0.007,0.995,0.102,3.1152]) \
      .setPosition([-0.1,13.4,-65]) \
     ) \
     .addChildren(ViewpointObject() \
      .setDescription("Cockpit Target View") \
      .setOrientation([-0.834,-0.523,-0.176,0.0875]) \
      .setPosition([0,2.4,-7.9]) \
     ) \
     .addChildren(TransformObject() \
      .setDEF("NoseAntennaTransform") \
      .setRotation([1,0,0,1.57]) \
      .setTranslation([0,-0.275,-21]) \
      .addChildren(ShapeObject() \
    ...
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("GearUpInterpolator") \
     .setKey([0,0.5,1]) \
     .setKeyValue([1,0,0,0,1,0,0,-0.79,1,0,0,-1.92]) \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("touchTime") \
     .setFromNode("TouchSensorUp") \
    ...
    .addChildren(ROUTEObject() \
     ...
     .setToNode("GearUpInterpolator") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("GearUpInterpolator") \
    ...
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("GearDownInterpolator") \
     .setKey([0,0.5,1]) \
     .setKeyValue([1,0,0,-1.92,1,0,0,-0.79,1,0,0,0]) \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("touchTime") \
     .setFromNode("TouchSensorDown") \
     .setToField("set_startTime") \
     .setToNode("WheelDown") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("WheelDown") \
     .setToField("set_fraction") \
     .setToNode("GearDownInterpolator") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("GearDownInterpolator") \
     .setToField("set_rotation") \
     .setToNode("FrontWheelTransform") \
    ) \
#Animation commands for Rear Right Wheel Starts
    ...
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("RRearInterUp1") \
     .setKey([0,0.5,1]) \
     .setKeyValue([-1,0,-1,0,-1,0,-1,0.44,-1,0,-1,1.92]) \
    ) \
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("RRearInterDown1") \
     .setKey([0,0.5,1]) \
     .setKeyValue([-1,0,-1,1.92,-1,0,-1,0.44,-1,0,-1,0]) \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("touchTime") \
     .setFromNode("TouchSensorDown") \
     .setToField("set_startTime") \
     .setToNode("RRearDown1") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("touchTime") \
     .setFromNode("TouchSensorUp") \
    ...
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("RRearDown1") \
     .setToField("set_fraction") \
     .setToNode("RRearInterDown1") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("RRearUp1") \
     .setToField("set_fraction") \
     .setToNode("RRearInterUp1") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("RRearInterDown1") \
     .setToField("set_rotation") \
     .setToNode("RearRightWheelTransform") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("RRearInterUp1") \
     .setToField("set_rotation") \
     .setToNode("RearRightWheelTransform") \
    ) \
#Animation commands for Rear Left Wheel
    ...
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("LRearInterUp1") \
     .setKey([0,0.5,1]) \
     .setKeyValue([1,0,1,0,1,0,1,0.44,1,0,1,1.92]) \
    ) \
    .addChildren(OrientationInterpolatorObject() \
     .setDEF("LRearInterDown1") \
     .setKey([0,0.5,1]) \
     .setKeyValue([1,0,1,1.92,1,0,1,0.44,1,0,1,0]) \
    ) \
    .addChildren(ROUTEObject() \
    ...
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("LRearDown1") \
     .setToField("set_fraction") \
     .setToNode("LRearInterDown1") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("LRearUp1") \
     .setToField("set_fraction") \
     .setToNode("LRearInterUp1") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("LRearInterDown1") \
     .setToField("set_rotation") \
     .setToNode("RearLeftWheelTransform") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("LRearInterUp1") \
     .setToField("set_rotation") \
     .setToNode("RearLeftWheelTransform") \
    ) \
    .addChildren(BackgroundObject() \
     .setGroundAngle([1.309,1.570796]) \
     .setGroundColor([0,0.3,0.7,0,0.35,0.75,0,0.4,0.8]) \
     .setSkyAngle([1.309,1.571]) \
     .setSkyColor([0,0.3,0.8,0,0.5,1,1,1,1]) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("RightmostAmraamTransform") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.4,1.4,1.4]) \
     .setTranslation([15.65,0,4.5]) \
     .addChildren(InlineObject() \
      .setDEF("Amraam") \
      .setUrl(["../../Weapons/Missiles/Amraam.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.x3d","../../Weapons/Missiles/Amraam.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("LeftmostAmraamTransform") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.4,1.4,1.4]) \
     .setTranslation([-15.65,0,4.5]) \
     .addChildren(InlineObject() \
    ...
    .addChildren(TransformObject() \
     .setDEF("SidewinderHolderTransformRight") \
     .setRotation([0,1,0,1.57]) \
     .setScale([6,3,3]) \
     .setTranslation([9,-1.125,8]) \
     .addChildren(InlineObject() \
      .setDEF("SidewinderHolder") \
      .setUrl(["SidewinderHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.x3d","SidewinderHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("SidewinderHolderTransformLeft") \
     .setRotation([0,1,0,1.57]) \
     .setScale([6,3,3]) \
     .setTranslation([-8.45,-1.125,8]) \
     .addChildren(InlineObject() \
      .setUSE("SidewinderHolder") \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("TurkishFlagTransformLeft") \
     .setRotation([0,-1,0,1.57]) \
     .setScale([0.3,0.25,0.3]) \
     .setTranslation([-0.01,8,19.5]) \
     .addChildren(InlineObject() \
      .setUrl(["TurkishFlagLeft.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.x3d","TurkishFlagLeft.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("TurkishFlagTransformRight") \
     .setRotation([0,1,0,1.57]) \
     .setScale([0.3,0.25,0.3]) \
     .setTranslation([0.01,8,20.5]) \
     .addChildren(InlineObject() \
      .setUrl(["TurkishFlagRight.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.x3d","TurkishFlagRight.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("AmraamHolderTransformLeft") \
     .setTranslation([-12,-0.176,10.7]) \
     .addChildren(InlineObject() \
      .setDEF("AmraamHolder") \
      .setUrl(["AmraamHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.x3d","AmraamHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("AmraamHolderTransformRight") \
     .setTranslation([12,-0.176,10.7]) \
     .addChildren(InlineObject() \
      .setUSE("AmraamHolder") \
     ) \
    ...
    .addChildren(TransformObject() \
     .setDEF("AmraamInnerTransformRight") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.4,1.4,1.4]) \
     .setTranslation([12,-1.6,4.5]) \
     .addChildren(InlineObject() \
      .setUSE("Amraam") \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("AmraamInnerTransformLeft") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.4,1.4,1.4]) \
     .setTranslation([-12,-1.6,4.5]) \
     .addChildren(InlineObject() \
    ...
    .addChildren(TransformObject() \
     .setDEF("SidewinderTransformLeft") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.6,1.6,1.6]) \
     .setTranslation([-8.7,-2,3.5]) \
     .addChildren(InlineObject() \
      .setDEF("Sidewinder") \
      .setUrl(["../../Weapons/Missiles/Sidewinder.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.x3d","../../Weapons/Missiles/Sidewinder.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("SidewinderTransformRight") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.6,1.6,1.6]) \
     .setTranslation([8.7,-2,3.5]) \
     .addChildren(InlineObject() \
    ...
    .addChildren(TransformObject() \
     .setDEF("FuelTankHolderTransformLeft") \
     .setRotation([0,1,0,1.57]) \
     .setScale([1.5,1.5,1.5]) \
     .setTranslation([-4.8,-1.125,6]) \
     .addChildren(InlineObject() \
      .setDEF("FuelTankHolder") \
      .setUrl(["FuelTankHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.x3d","FuelTankHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("FuelTankHolderTransformRight") \
     .setRotation([0,1,0,1.57]) \
     .setScale([1.5,1.5,1.5]) \
     .setTranslation([5.3,-1.125,6]) \
     .addChildren(InlineObject() \
      .setUSE("FuelTankHolder") \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("FuelTankTransformRight") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.5,1.5,1.5]) \
     .setTranslation([5,-2.85,5.5]) \
     .addChildren(InlineObject() \
      .setDEF("FuelTank") \
      .setUrl(["FuelTank.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.x3d","FuelTank.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.wrl"]) \
     ) \
    ) \
    .addChildren(TransformObject() \
     .setDEF("FuelTankTransformLeft") \
     .setRotation([-1,0,0,1.57]) \
     .setScale([1.5,1.5,1.5]) \
     .setTranslation([-5,-2.85,5.5]) \
     .addChildren(InlineObject() \
    ...
    .addChildren(TransformObject() \
     .setDEF("InlineCoverOfPlaneTansform") \
     .addChildren(ShapeObject() \
      .setGeometry(BoxObject(size = [4.15,0.1,20]) \
      ) \
      .setAppearance(AppearanceObject() \
       .setMaterial(MaterialObject() \
        .setDiffuseColor([0.25,0.25,0.25]) \
    ...
    .addChildren(TransformObject() \
     .setDEF("TargetHelicopterTransform") \
     .setTranslation([16,-50,-500]) \
     .addChildren(InlineObject() \
      .setUrl(["Target.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.x3d","Target.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.wrl"]) \
     ) \
    ) \
    .addChildren(TimeSensorObject() \
     .setDEF("FireClock") \
    ...
    .addChildren(PositionInterpolatorObject() \
     .setDEF("MissilePath") \
     .setKey([0,0.1,1]) \
     .setKeyValue([-15.65,0,4.5,-15.65,-2,4.5,16,-50,-500]) \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("touchTime") \
     .setFromNode("FireSensor") \
     .setToField("set_startTime") \
     .setToNode("FireClock") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("fraction_changed") \
     .setFromNode("FireClock") \
     .setToField("set_fraction") \
     .setToNode("MissilePath") \
    ) \
    .addChildren(ROUTEObject() \
     .setFromField("value_changed") \
     .setFromNode("MissilePath") \
     .setToField("set_translation") \
     .setToNode("LeftmostAmraamTransform") \
    ) \
    .addChildren(ViewpointObject() \
     .setDEF("MissileLaunchView") \
     .setDescription("Missile Fire View") \
     .setOrientation([0.094,-0.994,0.057,1.1716]) \
     .setPosition([-344.3,-142.8,-27.7]) \
    ) \
    .addChildren(ROUTEObject() \
