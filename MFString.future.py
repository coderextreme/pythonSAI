     ...
     .addChild(TransformObject() \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([24,0,3,-1,4,0,24,-1,25,26,27,-1,28,25,27,-1,27,29,28,-1,27,30,29,-1,27,31,30,-1,3,18,24,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([16,0,3,-1,4,0,16,-1,17,17,17,-1,18,18,18,-1,19,19,19,-1,20,20,20,-1,21,21,21,-1,3,14,16,-1]) \
        .setSolid(False) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([2,32,33,-1,34,32,2,-1,35,36,37,-1,38,36,35,-1,39,40,41,-1,37,36,42,-1,2,43,44,-1,33,43,2,-1,45,37,42,46,-1,46,42,47,48,-1,33,45,46,43,-1,43,46,48,44,-1,34,49,50,32,-1,32,50,45,33,-1,49,38,35,50,-1,50,35,37,45,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([2,22,23,-1,24,22,2,-1,25,26,27,-1,28,26,25,-1,29,29,29,-1,27,26,30,-1,2,31,32,-1,23,31,2,-1,33,27,30,34,-1,34,30,35,36,-1,23,33,34,31,-1,31,34,36,32,-1,24,37,38,22,-1,22,38,33,23,-1,37,28,25,38,-1,38,25,27,33,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([186,187,188,189,190,-1,190,191,192,193,186,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([118,119,120,121,122,-1,122,123,124,125,118,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([194,130,173,195,196,197,-1,197,198,199,82,81,194,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([126,126,126,126,126,126,-1,126,126,126,126,126,126,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([64,186,193,165,-1,203,204,164,163,-1,192,191,138,142,-1,191,190,96,138,-1,94,96,190,189,-1,95,94,189,188,-1,63,187,186,64,-1,62,61,205,206,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
      ...
      .addChild(ShapeObject() \
       ...
       .setGeometry(IndexedFaceSetObject() \
        .setCoordIndex([0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1]) \
        .setCreaseAngle(0.5) \
        .setNormalIndex([0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1]) \
        .setSolid(False) \
        .setCoord(CoordinateObject() \
         .setUSE("coordinates") \
        ) \
