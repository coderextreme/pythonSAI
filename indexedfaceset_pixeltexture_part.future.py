...
X3D0 = X3DObject() \
   ...
   .setHead(headObject() \
    ...
    .addMeta(metaObject() \
     .setName("identifier") \
     .setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d") \
    ) \
    .addMeta(metaObject() \
     .setName("generator") \
    ...
    .addChild(ShapeObject() \
     ...
     .setGeometry(IndexedFaceSetObject() \
      ...
      .setTexCoord(TextureCoordinateObject() \
       .setPoint([0.5,1,0.5,0.5,1,1,1,0.5]) \
      ) \
     ) \
    ) \
   ) \

X3D0.toFileX3D("./future/./indexedfaceset_pixeltexture_part.newf.x3d")
