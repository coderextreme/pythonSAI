...
ComposedShader26.setParts(ShaderPart38)
...
ComposedShader26.setParts(ShaderPart39)
...
field43.setValue("0.98 1.0 1.033")
...
ComposedShader40.setParts(ShaderPart53)
...
ComposedShader40.setParts(ShaderPart54)
