...
field17 = fieldObject().setName("xtranslation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
ProtoInterface16.addField(field17)
field18 = fieldObject().setName("myShape").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFNODE)
Shape19 = ShapeObject()
...
field30 = fieldObject().setName("ytranslation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
ProtoInterface29.addField(field30)
field31 = fieldObject().setName("myShape").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFNODE)
Shape32 = ShapeObject()
...
field54 = fieldObject().setName("ztranslation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
ProtoInterface53.addField(field54)
field55 = fieldObject().setName("myShape").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFNODE)
Shape56 = ShapeObject()
...
field78 = fieldObject().setName("ttranslation").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")
ProtoInterface77.addField(field78)
field79 = fieldObject().setName("myShape").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFNODE)
Shape80 = ShapeObject()
