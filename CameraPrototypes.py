...
Viewpoint43 = x3dpsail.Viewpoint()
Viewpoint43.setDEF("CameraViewpoint")
IS44 = x3dpsail.IS()
connect45 = x3dpsail.connect()
...
DirectionalLight57 = x3dpsail.DirectionalLight()
...
PositionInterpolator62 = x3dpsail.PositionInterpolator()
...
OrientationInterpolator65 = x3dpsail.OrientationInterpolator()
...
PositionInterpolator93 = x3dpsail.PositionInterpolator()
...
OrientationInterpolator95 = x3dpsail.OrientationInterpolator()
...
#=============== CameraShot ==============
ProtoDeclare131 = x3dpsail.ProtoDeclare()
...
ProtoInterface132 = x3dpsail.ProtoInterface()
...
#=============== CameraMovement ==============
ProtoDeclare175 = x3dpsail.ProtoDeclare()
...
ProtoInterface176 = x3dpsail.ProtoInterface()
field177 = x3dpsail.field()
...
ProtoBody189 = x3dpsail.ProtoBody()
...
#=============== OfflineRender ==============
ProtoDeclare216 = x3dpsail.ProtoDeclare()
...
ProtoInterface217 = x3dpsail.ProtoInterface()
#TODO non-photorealistic rendering (NPR) parameters
field218 = x3dpsail.field()
...
ProtoBody229 = x3dpsail.ProtoBody()
#First node determines node type of this prototype
#Subsequent nodes do not render, but still must be a valid X3D subgraph
Script230 = x3dpsail.Script()
Script230.setDEF("OfflineRenderScript")
Script230.setMustEvaluate(True)
field231 = x3dpsail.field()
...
Transform256 = x3dpsail.Transform()
Shape257 = x3dpsail.Shape()
Text258 = x3dpsail.Text()
...
X3D0.toFileX3D("././CameraPrototypes_RoundTrip.x3d")
