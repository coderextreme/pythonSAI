...
LayerSet33.setDEF("scene.addChildLayerSetTest")

Scene26.addLayerSet(LayerSet33)
...
PositionInterpolator46.setKey([0,0,0,0,0,1])
...
Text54.addComments(CommentsBlock("""Comment example A, plain quotation marks: He said, \"Immel did it!\""""))

Text54.addComments(CommentsBlock("""Comment example B, XML character entities: He said, &quot;Immel did it!&quot;"""))
...
Shape60.addComments(CommentsBlock("""alternative XML encoding: Text string='\"One, Two, Quote\" \"\" \"He said, \\&quot;Immel did it!\\&quot;\" \"\"'"""))
...
Text61 = TextObject()
Text61.setString(["One, Two, Quote","","He said, \"Immel did it!\", \"\""])
...
OrientationInterpolator62.setKey([0,0,1])
...
ColorInterpolator71.setKey([0,0,1])
...
Appearance89.addComments(CommentsBlock("""ArtDeco01Material prototype goes here... TODO ensure setContainerField is handled in exported Java"""))
...
Appearance94.addComments(CommentsBlock("""ArtDeco02Material prototype goes here... TODO ensure setContainerField is handled in exported Java"""))
...
X3D0.toFileX3D("././HelloWorldProgramOutput.new.new.x3d")
