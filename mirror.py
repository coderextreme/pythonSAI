...
meta6.setContent("http://coderextreme.net/X3DJSONLD/mirror.x3d")
...
Viewpoint9.setDescription("Switch background and cubemap texture")
...
ImageTexture11.setUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])

TextureBackground10.setLeftTexture(ImageTexture11)
ImageTexture12 = ImageTextureObject()
ImageTexture12.setDEF("rightBack")
ImageTexture12.setUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])

TextureBackground10.setRightTexture(ImageTexture12)
ImageTexture13 = ImageTextureObject()
ImageTexture13.setDEF("frontBack")
ImageTexture13.setUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])

TextureBackground10.setFrontTexture(ImageTexture13)
ImageTexture14 = ImageTextureObject()
ImageTexture14.setDEF("backBack")
ImageTexture14.setUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])

TextureBackground10.setBackTexture(ImageTexture14)
ImageTexture15 = ImageTextureObject()
ImageTexture15.setDEF("topBack")
ImageTexture15.setUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])

TextureBackground10.setTopTexture(ImageTexture15)
ImageTexture16 = ImageTextureObject()
ImageTexture16.setDEF("bottomBack")
ImageTexture16.setUrl(["cubemap/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture22.setUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])

ComposedCubeMapTexture21.setBack(ImageTexture22)
ImageTexture23 = ImageTextureObject()
ImageTexture23.setDEF("bottomShader")
ImageTexture23.setUrl(["cubemap/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_bottom.png"])

ComposedCubeMapTexture21.setBottom(ImageTexture23)
ImageTexture24 = ImageTextureObject()
ImageTexture24.setDEF("frontShader")
ImageTexture24.setUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])

ComposedCubeMapTexture21.setFront(ImageTexture24)
ImageTexture25 = ImageTextureObject()
ImageTexture25.setDEF("leftShader")
ImageTexture25.setUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])

ComposedCubeMapTexture21.setLeft(ImageTexture25)
ImageTexture26 = ImageTextureObject()
ImageTexture26.setDEF("rightShader")
ImageTexture26.setUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])

ComposedCubeMapTexture21.setRight(ImageTexture26)
ImageTexture27 = ImageTextureObject()
ImageTexture27.setDEF("topShader")
ImageTexture27.setUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])
...
ShaderPart34.setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"])

ComposedShader28.addParts(ShaderPart34)
ShaderPart35 = ShaderPartObject()
ShaderPart35.setType("FRAGMENT")
ShaderPart35.setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"])
...
ShaderPart42.setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"])

ComposedShader36.addParts(ShaderPart42)
ShaderPart43 = ShaderPartObject()
ShaderPart43.setType("FRAGMENT")
ShaderPart43.setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"])
