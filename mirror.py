...
field34 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader33.addField(field34)
field35 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader33.addField(field35)
field36 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader33.addField(field36)
field37 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader33.addField(field37)
field38 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader33.addField(field38)
ShaderPart39 = ShaderPartObject().setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"]).setType("VERTEX")
ComposedShader33.addParts(ShaderPart39)
ShaderPart40 = ShaderPartObject().setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"]).setType("FRAGMENT")
...
field42 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader41.addField(field42)
field43 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader41.addField(field43)
field44 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader41.addField(field44)
field45 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader41.addField(field45)
field46 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader41.addField(field46)
ShaderPart47 = ShaderPartObject().setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"]).setType("VERTEX")
ComposedShader41.addParts(ShaderPart47)
ShaderPart48 = ShaderPartObject().setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"]).setType("FRAGMENT")
...
field57 = fieldObject().setName("front_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field57)
field58 = fieldObject().setName("back_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field58)
field59 = fieldObject().setName("left_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field59)
field60 = fieldObject().setName("right_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field60)
field61 = fieldObject().setName("top_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field61)
field62 = fieldObject().setName("bottom_changed").setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)
Script50.addField(field62)
field63 = fieldObject().setName("set_fraction").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY)
Script50.addField(field63)
field64 = fieldObject().setName("old").setType(fieldObject.TYPE_SFINT32).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("-1")
