...
field32 = fieldObject().setName("cube").setType(fieldObject.TYPE_SFNODE).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT)
...
ShaderPart37 = ShaderPartObject().setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"]).setType("VERTEX")
ComposedShader30.addParts(ShaderPart37)
ShaderPart38 = ShaderPartObject().setDEF("common").setUrl(["common.fs","http://coderextreme.net/X3DJSONLD/common.fs"]).setType("FRAGMENT")
...
field40 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader39.addField(field40)
field41 = fieldObject().setName("cube").setType(fieldObject.TYPE_SFNODE).setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)
...
field43 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader39.addField(field43)
field44 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader39.addField(field44)
field45 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader39.addField(field45)
ShaderPart46 = ShaderPartObject().setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"]).setType("VERTEX")
