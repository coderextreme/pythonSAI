...
Material22.setDiffuseColor([.25,.25,.25])
...
Material28.setDiffuseColor([.25,.25,.25])
...
Material34.setDiffuseColor([.1796,.1914,.2382])
...
Material40.setDiffuseColor([.5,.5,.5])
...
Material46.setDiffuseColor([.2304,.2304,.2304])
...
Material52.setDiffuseColor([.6,.6,.6])
...
Material58.setDiffuseColor([.37,.37,.37])
Material58.setShininess(.5)
...
Material64.setEmissiveColor([.1796,.1914,.2382])
...
Material70.setDiffuseColor([.6,.6,.6])
...
Transform85.setScale([.008,.008,.008])
...
Transform91.setScale([.008,.008,.008])
...
Transform97.setScale([.06,.06,.06])
Transform97.setTranslation([-.65,1.55,-10])
...
Transform102.setScale([.06,.06,.06])
Transform102.setTranslation([-.65,1.35,-10])
...
Transform107.setScale([.008,.008,.008])
Transform107.setTranslation([.52,1.6,-10])
...
Material111.setDiffuseColor([0,.75,.18])
Material111.setShininess(.8)
...
Transform113.setScale([.06,.06,.06])
Transform113.setTranslation([.36,1.5,-10])
...
Material117.setDiffuseColor([0,.75,.18])
...
OrientationInterpolator130.setKey([0,0.5,1.0])
OrientationInterpolator130.setKeyValue([1,0,0,0.0,1,0,0,-0.79,1,0,0,-1.92])
...
OrientationInterpolator135.setKey([0,0.5,1.0])
OrientationInterpolator135.setKeyValue([1,0,0,-1.92,1,0,0,-0.79,1,0,0,0.0])
...
OrientationInterpolator141.setKey([0,0.5,1.0])
OrientationInterpolator141.setKeyValue([-1,0,-1,0.0,-1,0,-1,0.44,-1,0,-1,1.92])
...
OrientationInterpolator142.setKey([0,0.5,1.0])
OrientationInterpolator142.setKeyValue([-1,0,-1,1.92,-1,0,-1,0.44,-1,0,-1,0.0])
...
OrientationInterpolator151.setKey([0,0.5,1.0])
OrientationInterpolator151.setKeyValue([1,0,1,0.0,1,0,1,0.44,1,0,1,1.92])
...
OrientationInterpolator152.setKey([0,0.5,1.0])
OrientationInterpolator152.setKeyValue([1,0,1,1.92,1,0,1,0.44,1,0,1,0.0])
...
Background159.setGroundColor([0,0.3,.7,0,0.35,0.75,0,0.4,0.8])
...
Transform168.setScale([.3,.25,.3])
Transform168.setTranslation([-.01,8,19.5])
...
Transform170.setScale([.3,.25,.3])
Transform170.setTranslation([.01,8,20.5])
...
Transform172.setTranslation([-12,-.176,10.7])
...
Transform174.setTranslation([12,-.176,10.7])
...
PositionInterpolator200.setKey([0.0,.1,1.0])
