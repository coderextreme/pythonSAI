...
field32 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader31.addField(field32)
field33 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader31.addField(field33)
field34 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader31.addField(field34)
field35 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader31.addField(field35)
field36 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader31.addField(field36)
ShaderPart37 = ShaderPartObject().setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"]).setType("VERTEX")
ComposedShader31.addParts(ShaderPart37)
ShaderPart38 = ShaderPartObject().setUrl(["pc_bubbles.fs","http://coderextreme.net/X3DJSONLD/pc_bubbles.fs"]).setType("FRAGMENT")
...
field40 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader39.addField(field40)
field41 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader39.addField(field41)
field42 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader39.addField(field42)
field43 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader39.addField(field43)
field44 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader39.addField(field44)
ShaderPart45 = ShaderPartObject().setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"]).setType("VERTEX")
ComposedShader39.addParts(ShaderPart45)
ShaderPart46 = ShaderPartObject().setUrl(["pc_bubbles.fs","http://coderextreme.net/X3DJSONLD/pc_bubbles.fs"]).setType("FRAGMENT")
...
field51 = fieldObject().setName("set_cycle").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFTIME)
Script50.addField(field51)
field52 = fieldObject().setName("lastKey").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0")
Script50.addField(field52)
field53 = fieldObject().setName("orientations").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFROTATION).setValue("0 1 0 0 0 1 0 -1.57 0 1 0 3.14 0 1 0 1.57 0 1 0 0 1 0 0 -1.57 0 1 0 0 1 0 0 1.57 0 1 0 0")
Script50.addField(field53)
field54 = fieldObject().setName("positions").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFVEC3F).setValue("0 0 10 -10 0 0 0 0 -10 10 0 0 0 0 10 0 10 0 0 0 10 0 -10 0 0 0 10")
Script50.addField(field54)
field55 = fieldObject().setName("position").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFVEC3F)
Script50.addField(field55)
field56 = fieldObject().setName("orientation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFROTATION)
