...
ComposedCubeMapTexture21 = x3dpsail.ComposedCubeMapTexture()
...
ComposedShader28 = x3dpsail.ComposedShader()
...
ComposedShader36 = x3dpsail.ComposedShader()
...
OrientationInterpolator46 = x3dpsail.OrientationInterpolator()
