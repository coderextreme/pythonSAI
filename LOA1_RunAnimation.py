...
PositionInterpolator58.setKeyValue([0,-0.0351,0,0,-0.0351,0,0,-0.04087,0,0,-0.04886,0,0,-0.04051,0,0,-0.03666,0,0,-0.03666,0,0,-0.0351,0])
IS59 = IS()
connect60 = connect()
...
OrientationInterpolator64.setKeyValue([0.9969,-0.05444,0.05596,0.07687,0.9969,-0.05444,0.05596,0.07687])
IS65 = IS()
connect66 = connect()
...
OrientationInterpolator67.setKeyValue([-0.9986,0.03354,0.04001,1.212,-0.9889,0.1328,0.06696,0.4025,0.9894,0.1453,0.009351,0.4114,-0.9963,0.07032,0.05003,0.7035,-0.9986,0.03354,0.04001,1.212])
IS68 = IS()
connect69 = connect()
...
OrientationInterpolator70.setKeyValue([1,0,0,1.108,1,0,0,0.4265,1,0,0,0.7052,1,0,0,2.179,1,0,0,1.108])
IS71 = IS()
connect72 = connect()
...
OrientationInterpolator73.setKeyValue([1,0,0,0.03543,-1,0,0,0.1037,-1,0,0,0.4328,1,0,0,0.1929,1,0,0,0.03543])
IS74 = IS()
connect75 = connect()
...
OrientationInterpolator79.setKeyValue([0.9999,0.00293,-0.00989,0.402,-1,0.004977,-0.00497,0.5943,-1,0.003265,-0.001752,1.178,-0.9999,0.00815,-0.01093,0.3031,0.9999,0.00293,-0.00989,0.402])
IS80 = IS()
connect81 = connect()
...
OrientationInterpolator82.setKeyValue([1,0,0,0.7004,1,0,0,1.011,1,0,0,1.892,1,0,0,1.188,1,0,0,0.3964,1,0,0,0.7004])
IS83 = IS()
connect84 = connect()
...
OrientationInterpolator85.setKeyValue([1,0,0,0.2323,-1,0,0,0.07843,-1,0,0,0.09676,-1,0,0,0.3274,-1,0,0,0.3278,1,0,0,0.2323])
IS86 = IS()
connect87 = connect()
...
OrientationInterpolator91.setKeyValue([0.7651,0.6382,0.08586,0.2712,0.9999,0.002845,-0.01547,0.3756,0.7459,-0.6505,-0.1432,0.2416,0.9984,0.05536,-0.01154,0.3488,0.7651,0.6382,0.08586,0.2712])
IS92 = IS()
connect93 = connect()
...
OrientationInterpolator94.setKeyValue([0.6517,-0.7559,0.06211,0.2508,0.6467,0.7527,-0.1238,0.2344,0.6517,-0.7559,0.06211,0.2508])
IS95 = IS()
connect96 = connect()
...
OrientationInterpolator97.setKeyValue([0.9907,-0.07264,0.115,1.135,0.9291,-0.1222,0.349,0.1695,-0.9892,0.1364,-0.05394,0.5112,0.9942,-0.0002052,0.1073,0.4975,0.9907,-0.07264,0.115,1.135])
IS98 = IS()
connect99 = connect()
...
OrientationInterpolator100.setKeyValue([0.9985,0.03887,0.03802,4.689,-0.965,-0.1889,-0.1821,1.415,0.9758,0.1563,0.1529,4.666,-0.9956,-0.0936,0.009826,1.126,0.9985,0.03887,0.03802,4.689])
IS101 = IS()
connect102 = connect()
...
OrientationInterpolator103.setKeyValue([-0.0240995,-0.999682,0.00741506,0.120409,-0.0240995,-0.999682,0.00741506,0.120409])
IS104 = IS()
connect105 = connect()
...
OrientationInterpolator106.setKeyValue([-1,0,0,0.6979,0.9094,0.2062,-0.3613,0.4157,0.9637,0.1537,-0.2185,1.353,0.4864,0.08841,-0.8693,0.1716,-1,0,0,0.6979])
IS107 = IS()
connect108 = connect()
...
OrientationInterpolator109.setKeyValue([0.9353,-0.2978,-0.191,4.222,-0.9362,0.2924,-0.1952,1.05,0.9941,-0.09719,-0.04725,4.512,-0.9594,0.2653,0.09579,1.525,0.9353,-0.2978,-0.191,4.222])
IS110 = IS()
connect111 = connect()
...
OrientationInterpolator112.setKeyValue([-0.917742,-0.237244,-0.318536,0.214273,-0.917742,-0.237244,-0.318536,0.214273])
IS113 = IS()
connect114 = connect()
...
X3D0.toFileX3D("././LOA1_RunAnimation_RoundTrip.x3d")
