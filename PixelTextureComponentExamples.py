...
PixelTexture32 = x3dpsail.PixelTexture()
...
PixelTexture42 = x3dpsail.PixelTexture()
...
Text46 = x3dpsail.Text()
Text46.setString(["2"])
FontStyle47 = x3dpsail.FontStyle()
...
Shape50 = x3dpsail.Shape()
Appearance51 = x3dpsail.Appearance()
#note 0x000000 = 0
PixelTexture52 = x3dpsail.PixelTexture()
...
Shape60 = x3dpsail.Shape()
Appearance61 = x3dpsail.Appearance()
#Erroneous value in book: 1 0 0 255, 0 1 0 255, 0 0 1 255, 1 0 0 127, 0 1 0 127, 0 0 1 127
PixelTexture62 = x3dpsail.PixelTexture()
...
Shape65 = x3dpsail.Shape()
Text66 = x3dpsail.Text()
Text66.setString(["4"])
FontStyle67 = x3dpsail.FontStyle()
FontStyle67.setUSE("CenterJustify")

Text66.setFontStyle(FontStyle67)

Shape65.setGeometry(Text66)
Appearance68 = x3dpsail.Appearance()
...
Transform69 = x3dpsail.Transform()
Transform69.setTranslation([0,6,-2])
Shape70 = x3dpsail.Shape()
Appearance71 = x3dpsail.Appearance()
PixelTexture72 = x3dpsail.PixelTexture()
...
X3D0.toFileX3D("././PixelTextureComponentExamples_RoundTrip.x3d")
