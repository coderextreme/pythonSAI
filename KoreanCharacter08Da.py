...
HAnimJoint31.center = [0,32.730000,-1.981000]
...
Transform33.translation = [0,32.730000,-1.981000]
Shape34 = x3d.Shape()
...
HAnimJoint41.center = [3.180000,31.250000,-0.949100]
...
Transform43.translation = [3.180000,31.250000,-0.949100]
Shape44 = x3d.Shape()
...
HAnimJoint51.center = [3.414000,17.040001,-0.955600]
...
Transform53.translation = [3.414000,17.040001,-0.955600]
Shape54 = x3d.Shape()
...
HAnimJoint61.center = [3.631000,4.504000,-0.746100]
...
Transform63.translation = [3.631000,4.504000,-0.746100]
Shape64 = x3d.Shape()
...
HAnimJoint71.center = [3.631000,3.792000,0.054790]
...
Transform73.translation = [3.631000,3.792000,0.054790]
Shape74 = x3d.Shape()
...
HAnimJoint81.center = [-3.180000,31.250000,-0.949100]
...
Transform83.translation = [-3.180000,31.250000,-0.949100]
Shape84 = x3d.Shape()
...
HAnimJoint91.center = [-3.414000,17.040001,-0.955600]
...
Transform93.translation = [-3.414000,17.040001,-0.955600]
Shape94 = x3d.Shape()
...
HAnimJoint101.center = [-3.631000,4.504000,-0.746100]
...
Transform103.translation = [-3.631000,4.504000,-0.746100]
Shape104 = x3d.Shape()
...
HAnimJoint111.center = [-3.631000,3.792000,0.054790]
...
Transform113.translation = [-3.631000,3.792000,0.054790]
Shape114 = x3d.Shape()
...
HAnimJoint121.center = [0,29.620001,-1.431000]
...
Transform123.translation = [0,29.620001,-1.431000]
Shape124 = x3d.Shape()
...
HAnimJoint131.center = [6.320000,49.709999,-1.215000]
...
Transform133.translation = [6.320000,49.709999,-1.215000]
Shape134 = x3d.Shape()
...
HAnimJoint141.center = [6.687000,42.259998,-1.215000]
...
Transform143.translation = [6.687000,42.259998,-1.215000]
Shape144 = x3d.Shape()
...
HAnimJoint151.center = [7.341000,34.169998,-1.443000]
...
Transform153.translation = [7.341000,34.169998,-1.443000]
Shape154 = x3d.Shape()
...
HAnimJoint161.center = [-6.320000,49.709999,-1.215000]
...
Transform163.translation = [-6.320000,49.709999,-1.215000]
Shape164 = x3d.Shape()
...
HAnimJoint171.center = [-6.687000,42.259998,-1.215000]
...
Transform173.translation = [-6.687000,42.259998,-1.215000]
Shape174 = x3d.Shape()
...
HAnimJoint181.center = [-7.341000,34.169998,-1.443000]
...
Transform183.translation = [-7.341000,34.169998,-1.443000]
Shape184 = x3d.Shape()
...
HAnimJoint191.center = [0,36.869999,-1.035000]
...
Transform193.translation = [0,36.869999,-1.035000]
Shape194 = x3d.Shape()
...
HAnimJoint201.center = [0,53.980000,-1.219000]
...
Transform203.translation = [0,53.980000,-1.219000]
Shape204 = x3d.Shape()
...
X3D0.Scene = Scene19
f = open("KoreanCharacter08Da_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
