...
meta2 = meta()
meta2.setName("title")
meta2.setContent("LOA1_StopAnimation.x3d")
...
meta13.setContent("Nancy Stand Animation HAnim 2001")

head1.addMeta(meta13)
meta14 = meta()
meta14.setName("identifier")
meta14.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_StopAnimation.x3d")
...
WorldInfo18.setTitle("LOA1_StopAnimation.x3d")

Scene17.addChildren(WorldInfo18)
ProtoDeclare19 = ProtoDeclare()
ProtoDeclare19.setName("LOA1_StopAnimation")
...
PositionInterpolator58.setKey([0,1])
PositionInterpolator58.setKeyValue([0,0,0,0,0,0])
IS59 = IS()
connect60 = connect()
...
OrientationInterpolator61.setKeyValue([0,0,1,0,0,0,1,0])
IS62 = IS()
connect63 = connect()
...
OrientationInterpolator64.setKeyValue([0,0,1,0,0,0,1,0])
IS65 = IS()
connect66 = connect()
...
OrientationInterpolator67.setKey([0,1])
OrientationInterpolator67.setKeyValue([0,0,1,0,0,0,1,0])
IS68 = IS()
connect69 = connect()
...
OrientationInterpolator70.setKey([0,1])
OrientationInterpolator70.setKeyValue([0,0,1,0,0,0,1,0])
IS71 = IS()
connect72 = connect()
...
OrientationInterpolator73.setKey([0,1])
OrientationInterpolator73.setKeyValue([0,0,1,0,0,0,1,0])
IS74 = IS()
connect75 = connect()
...
OrientationInterpolator76.setKey([0,1])
OrientationInterpolator76.setKeyValue([1,0,0,0,1,0,0,0])
IS77 = IS()
connect78 = connect()
...
OrientationInterpolator79.setKey([0,1])
OrientationInterpolator79.setKeyValue([0,0,1,0,0,0,1,0])
IS80 = IS()
connect81 = connect()
...
OrientationInterpolator82.setKeyValue([0,0,1,0,0,0,1,0])
IS83 = IS()
connect84 = connect()
...
OrientationInterpolator85.setKey([0,1])
OrientationInterpolator85.setKeyValue([0,0,1,0,0,0,1,0])
IS86 = IS()
connect87 = connect()
...
OrientationInterpolator88.setKey([0,1])
OrientationInterpolator88.setKeyValue([1,0,0,0,1,0,0,0])
IS89 = IS()
connect90 = connect()
...
OrientationInterpolator91.setKey([0,1])
OrientationInterpolator91.setKeyValue([0,0,1,0,0,0,1,0])
IS92 = IS()
connect93 = connect()
...
OrientationInterpolator94.setKey([0,1])
OrientationInterpolator94.setKeyValue([0,0,1,0,0,0,1,0])
IS95 = IS()
connect96 = connect()
...
OrientationInterpolator97.setKey([0,1])
OrientationInterpolator97.setKeyValue([0,0,1,0,0,0,1,0])
IS98 = IS()
connect99 = connect()
...
OrientationInterpolator100.setKey([0,1])
OrientationInterpolator100.setKeyValue([0,0,1,0,0,0,1,0])
IS101 = IS()
connect102 = connect()
...
OrientationInterpolator103.setKeyValue([0,0,1,0,0,0,1,0])
IS104 = IS()
connect105 = connect()
...
OrientationInterpolator106.setKey([0,1])
OrientationInterpolator106.setKeyValue([0,0,1,0,0,0,1,0])
IS107 = IS()
connect108 = connect()
...
OrientationInterpolator109.setKey([0,1])
OrientationInterpolator109.setKeyValue([0,0,1,0,0,0,1,0])
IS110 = IS()
connect111 = connect()
...
OrientationInterpolator112.setKeyValue([0,0,1,0,0,0,1,0])
IS113 = IS()
connect114 = connect()
...
Shape135 = Shape()
Text136 = Text()
Text136.setString(["LOA1_StopAnimation.x3d","defines a prototype","for animating a humanoid.","","Click this text to see","InterchangableActorsViaDynamicRouting example."])
...
X3D0.toFileX3D("././LOA1_StopAnimation_RoundTrip.x3d")
