...
meta3 = x3d.meta()
meta3.content = "KoreanCharacter10Mi.x3d"
meta3.name = "title"
...
meta13 = x3d.meta()
meta13.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter10Mi.x3d"
...
WorldInfo20.title = "KoreanCharacter10Mi.x3d"
...
HAnimJoint31.center = [0,32.680000,-0.707600]
...
Transform33.translation = [0,32.680000,-0.707600]
Shape34 = x3d.Shape()
...
ImageTexture37.DEF = "MiTextureAtlas"
ImageTexture37.url = ["images/Mi.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Mi.png"]
...
HAnimJoint41.center = [3.309000,31.309999,-0.837700]
...
Transform43.translation = [3.309000,31.309999,-0.837700]
Shape44 = x3d.Shape()
...
HAnimJoint51.center = [3.584000,17.160000,-1.037000]
...
Transform53.translation = [3.584000,17.160000,-1.037000]
Shape54 = x3d.Shape()
...
ImageTexture57.USE = "MiTextureAtlas"
...
HAnimJoint61.center = [3.602000,4.137000,0.610400]
...
Transform63.translation = [3.602000,4.137000,0.610400]
Shape64 = x3d.Shape()
...
ImageTexture67.USE = "MiTextureAtlas"
...
HAnimJoint71.center = [3.602000,3.020000,0.070170]
...
Transform73.translation = [3.602000,3.020000,0.070170]
Shape74 = x3d.Shape()
...
HAnimJoint81.center = [-3.309000,31.309999,-0.837700]
...
Transform83.translation = [-3.309000,31.309999,-0.837700]
Shape84 = x3d.Shape()
...
HAnimJoint91.center = [-3.584000,17.160000,-1.037000]
...
Transform93.translation = [-3.584000,17.160000,-1.037000]
Shape94 = x3d.Shape()
...
HAnimJoint101.center = [-3.602000,4.137000,0.610400]
...
Transform103.translation = [-3.602000,4.137000,0.610400]
Shape104 = x3d.Shape()
...
ImageTexture107.USE = "MiTextureAtlas"
...
HAnimJoint111.center = [-3.602000,3.020000,0.070170]
...
Transform113.translation = [-3.602000,3.020000,0.070170]
Shape114 = x3d.Shape()
...
HAnimJoint121.center = [0.050530,30.200001,-1.380000]
...
Transform123.translation = [0.050530,30.200001,-1.380000]
Shape124 = x3d.Shape()
...
HAnimJoint131.center = [6.032000,48.580002,-1.277000]
...
Transform133.translation = [6.032000,48.580002,-1.277000]
Shape134 = x3d.Shape()
...
HAnimJoint141.center = [6.032000,40.810001,-1.412000]
...
Transform143.translation = [6.032000,40.810001,-1.412000]
Shape144 = x3d.Shape()
...
HAnimJoint151.center = [6.934000,33.959999,-1.108000]
...
Transform153.translation = [6.934000,33.959999,-1.108000]
Shape154 = x3d.Shape()
...
ImageTexture157.USE = "MiTextureAtlas"
...
HAnimJoint161.center = [-6.032000,48.580002,-1.277000]
...
Transform163.translation = [-6.032000,48.580002,-1.277000]
Shape164 = x3d.Shape()
...
HAnimJoint171.center = [-6.032000,40.810001,-1.412000]
...
Transform173.translation = [-6.032000,40.810001,-1.412000]
Shape174 = x3d.Shape()
...
HAnimJoint181.center = [-6.934000,33.959999,-1.108000]
...
Transform183.translation = [-6.934000,33.959999,-1.108000]
Shape184 = x3d.Shape()
...
ImageTexture187.USE = "MiTextureAtlas"
...
HAnimJoint191.center = [0,35.310001,-2.314000]
...
Transform193.translation = [0,35.310001,-2.314000]
Shape194 = x3d.Shape()
...
HAnimJoint201.center = [0,35.310001,-2.314000]
...
Transform203.translation = [0,35.310001,-2.314000]
Shape204 = x3d.Shape()
...
ImageTexture207.USE = "MiTextureAtlas"
...
X3D0.Scene = Scene19
f = open("KoreanCharacter10Mi_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
