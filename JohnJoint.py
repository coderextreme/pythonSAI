...
NavigationInfo28.type = ["EXAMINE","ANY"]

Scene10.children.append(NavigationInfo28)
Viewpoint29 = x3d.Viewpoint()
Viewpoint29.centerOfRotation = [0,0,0]
...
HAnimHumanoid30.scale = [1,1,1]
HAnimHumanoid30.translation = [0,0,0]
...
HAnimJoint34.center = [0.1040,0.4867,0.0308]
...
HAnimJoint61.center = [-0.0950,0.9171,0.0029]
...
HAnimJoint92.center = [0.0045,1.1546,-0.0800]
...
HAnimJoint95.center = [0.0053,1.2679,-0.0810]
...
HAnimJoint108.center = [0.0066,1.5520,-0.0082]
...
HAnimJoint110.center = [0.0066,1.5800,-0.0103]
...
HAnimJoint121.center = [0.0820,1.4488,-0.0353]
...
HAnimJoint149.center = [-0.0694,1.4600,-0.0330]
...
HAnimJoint152.center = [-0.1949,1.1388,-0.0620]
...
HAnimJoint157.center = [-0.1864,0.8190,0.0506]
...
HAnimJoint164.center = [-0.1972,0.8060,-0.0468]
...
HAnimJoint166.center = [-0.1950,0.7304,-0.0441]
...
HAnimJoint171.center = [-0.1920,0.7318,-0.0716]
...
HAnimJoint176.center = [-0.1908,0.7540,-0.0960]
