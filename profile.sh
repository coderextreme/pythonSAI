...
export CLASSPATH=${PYJHOME}/pythonSAI/jslint4java-2.0.5.jar:${PYJHOME}/pythonSAI/json-schema-validator-2.2.6-lib.jar:${PYJHOME}/pythonSAI/saxon9he.jar:${PYJHOME}/pythonSAI/X3DJSAIL.3.3.classes.jar:${PYJHOME}/pythonSAI/X3DJSAIL.3.3.full.jar
