...
X3D0.setHead(head1)
Scene21 = x3dpsail.Scene()
#=============== Camera ==============
ExternProtoDeclare22 = x3dpsail.ExternProtoDeclare()
...
#=============== CameraShot ==============
ExternProtoDeclare46 = x3dpsail.ExternProtoDeclare()
...
#=============== CameraMovement ==============
ExternProtoDeclare59 = x3dpsail.ExternProtoDeclare()
...
#=============== OfflineRender ==============
ExternProtoDeclare72 = x3dpsail.ExternProtoDeclare()
...
DirectionalLight84 = x3dpsail.DirectionalLight()
...
ProtoInstance88 = x3dpsail.ProtoInstance()
...
ProtoInstance93 = x3dpsail.ProtoInstance()
ProtoInstance93.setName("CameraShot")
ProtoInstance93.setDEF("Zoom")
fieldValue94 = x3dpsail.fieldValue()
...
fieldValue95 = x3dpsail.fieldValue()
...
ProtoInstance113 = x3dpsail.ProtoInstance()
ProtoInstance113.setName("CameraShot")
ProtoInstance113.setDEF("Dolly")
fieldValue114 = x3dpsail.fieldValue()
...
ProtoInstance123 = x3dpsail.ProtoInstance()
ProtoInstance123.setName("CameraMovement")
fieldValue124 = x3dpsail.fieldValue()
...
ProtoInstance133 = x3dpsail.ProtoInstance()
ProtoInstance133.setName("CameraShot")
ProtoInstance133.setDEF("Pan")
fieldValue134 = x3dpsail.fieldValue()
...
ProtoInstance148 = x3dpsail.ProtoInstance()
ProtoInstance148.setName("CameraMovement")
fieldValue149 = x3dpsail.fieldValue()
...
ProtoInstance153 = x3dpsail.ProtoInstance()
ProtoInstance153.setName("CameraMovement")
fieldValue154 = x3dpsail.fieldValue()
...
ProtoInstance158 = x3dpsail.ProtoInstance()
ProtoInstance158.setName("CameraShot")
ProtoInstance158.setDEF("CameraBoom")
fieldValue159 = x3dpsail.fieldValue()
...
Group219 = x3dpsail.Group()
Group219.setDEF("AnimationGroup.SimpleShots")
TimeSensor220 = x3dpsail.TimeSensor()
...
Shape234 = x3dpsail.Shape()
Shape234.setDEF("TransparentBox")
Appearance235 = x3dpsail.Appearance()
Material236 = x3dpsail.Material()
...
Group238 = x3dpsail.Group()
Group238.setDEF("SimpleShotsTargets")
Transform239 = x3dpsail.Transform()
Transform239.setDEF("TargetBoxZoom")
Transform239.setTranslation([-50,1,-20])
Shape240 = x3dpsail.Shape()
Box241 = x3dpsail.Box()

Shape240.setGeometry(Box241)
Appearance242 = x3dpsail.Appearance()
Material243 = x3dpsail.Material()

Appearance242.setMaterial(Material243)
ImageTexture244 = x3dpsail.ImageTexture()
...
Transform245 = x3dpsail.Transform()
Transform245.setTranslation([0,2,0])
Shape246 = x3dpsail.Shape()
Text247 = x3dpsail.Text()
Text247.setString(["Zoom in, out"])
FontStyle248 = x3dpsail.FontStyle()
FontStyle248.setJustify(["MIDDLE","MIDDLE"])

Text247.setFontStyle(FontStyle248)

Shape246.setGeometry(Text247)
Appearance249 = x3dpsail.Appearance()
Material250 = x3dpsail.Material()
...
Transform251 = x3dpsail.Transform()
Transform251.setDEF("TargetBoxDolly")
Transform251.setTranslation([-40,1,-20])
Shape252 = x3dpsail.Shape()
Box253 = x3dpsail.Box()

Shape252.setGeometry(Box253)
Appearance254 = x3dpsail.Appearance()
Material255 = x3dpsail.Material()

Appearance254.setMaterial(Material255)
ImageTexture256 = x3dpsail.ImageTexture()
...
Transform257 = x3dpsail.Transform()
Transform257.setTranslation([0,2,0])
Shape258 = x3dpsail.Shape()
Text259 = x3dpsail.Text()
Text259.setString(["Dolly left, right"])
FontStyle260 = x3dpsail.FontStyle()
FontStyle260.setJustify(["MIDDLE","MIDDLE"])

Text259.setFontStyle(FontStyle260)

Shape258.setGeometry(Text259)
Appearance261 = x3dpsail.Appearance()
Material262 = x3dpsail.Material()
...
Transform263 = x3dpsail.Transform()
Transform263.setDEF("TargetBoxPan")
Transform263.setTranslation([-30,1,-20])
Shape264 = x3dpsail.Shape()
Box265 = x3dpsail.Box()

Shape264.setGeometry(Box265)
Appearance266 = x3dpsail.Appearance()
Material267 = x3dpsail.Material()

Appearance266.setMaterial(Material267)
ImageTexture268 = x3dpsail.ImageTexture()
...
Transform269 = x3dpsail.Transform()
Transform269.setTranslation([0,2,0])
Shape270 = x3dpsail.Shape()
Text271 = x3dpsail.Text()
Text271.setString(["Pan left, right"])
FontStyle272 = x3dpsail.FontStyle()
FontStyle272.setJustify(["MIDDLE","MIDDLE"])

Text271.setFontStyle(FontStyle272)

Shape270.setGeometry(Text271)
Appearance273 = x3dpsail.Appearance()
Material274 = x3dpsail.Material()
...
Transform275 = x3dpsail.Transform()
Transform275.setDEF("TargetBoxBoom")
Transform275.setTranslation([-20,1,-20])
Shape276 = x3dpsail.Shape()
Box277 = x3dpsail.Box()

Shape276.setGeometry(Box277)
Appearance278 = x3dpsail.Appearance()
Material279 = x3dpsail.Material()

Appearance278.setMaterial(Material279)
ImageTexture280 = x3dpsail.ImageTexture()
...
Transform281 = x3dpsail.Transform()
Transform281.setTranslation([0,2,0])
Shape282 = x3dpsail.Shape()
Text283 = x3dpsail.Text()
Text283.setString(["Boom up, down"])
FontStyle284 = x3dpsail.FontStyle()
FontStyle284.setJustify(["MIDDLE","MIDDLE"])

Text283.setFontStyle(FontStyle284)

Shape282.setGeometry(Text283)
Appearance285 = x3dpsail.Appearance()
Material286 = x3dpsail.Material()
...
Transform287 = x3dpsail.Transform()
Transform287.setDEF("TargetBoxTilt")
Transform287.setTranslation([-10,1,-20])
Shape288 = x3dpsail.Shape()
Box289 = x3dpsail.Box()

Shape288.setGeometry(Box289)
Appearance290 = x3dpsail.Appearance()
Material291 = x3dpsail.Material()

Appearance290.setMaterial(Material291)
ImageTexture292 = x3dpsail.ImageTexture()
...
Transform293 = x3dpsail.Transform()
Transform293.setTranslation([0,2,0])
Shape294 = x3dpsail.Shape()
Text295 = x3dpsail.Text()
Text295.setString(["Tilt left, right"])
FontStyle296 = x3dpsail.FontStyle()
FontStyle296.setJustify(["MIDDLE","MIDDLE"])

Text295.setFontStyle(FontStyle296)

Shape294.setGeometry(Text295)
Appearance297 = x3dpsail.Appearance()
Material298 = x3dpsail.Material()
...
ProtoInstance346 = x3dpsail.ProtoInstance()
...
ExternProtoDeclare360 = x3dpsail.ExternProtoDeclare()
...
fieldValue372 = x3dpsail.fieldValue()
fieldValue372.setName("NavigationInfoNode")
NavigationInfo373 = x3dpsail.NavigationInfo()
...
IndexedFaceSet386 = x3dpsail.IndexedFaceSet()
...
Coordinate387 = x3dpsail.Coordinate()
...
Transform391 = x3dpsail.Transform()
Transform391.setDEF("MovingBoxTransform")
PositionInterpolator392 = x3dpsail.PositionInterpolator()
...
TimeSensor393 = x3dpsail.TimeSensor()
...
Shape399 = x3dpsail.Shape()
Box400 = x3dpsail.Box()

Shape399.setGeometry(Box400)
Appearance401 = x3dpsail.Appearance()
Material402 = x3dpsail.Material()

Appearance401.setMaterial(Material402)
ImageTexture403 = x3dpsail.ImageTexture()
...
ExternProtoDeclare404 = x3dpsail.ExternProtoDeclare()
...
Appearance422 = x3dpsail.Appearance()
Material423 = x3dpsail.Material()
