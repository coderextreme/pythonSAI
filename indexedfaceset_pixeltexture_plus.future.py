...
X3D0 = X3DObject() \
   ...
   .setHead(headObject() \
    ...
    .addMeta(metaObject() \
     .setName("identifier") \
     .setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d") \
    ) \
    .addMeta(metaObject() \
     .setName("generator") \
    ...
    .addChild(ShapeObject() \
     ...
     .setGeometry(IndexedFaceSetObject() \
      ...
      .setTexCoord(TextureCoordinateObject() \
       .setPoint([-1,2,-1,-1,2,2,2,-1]) \
      ) \
     ) \
    ) \
   ) \

X3D0.toFileX3D("./future/./indexedfaceset_pixeltexture_plus.newf.x3d")
