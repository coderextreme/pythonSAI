...
PositionInterpolator58.key = [0,.3125,.625,1]
IS59 = x3d.IS()
...
OrientationInterpolator64.key = [0,.3125,.625,1]
IS65 = x3d.IS()
...
OrientationInterpolator67.key = [0,.3125,.625,1]
IS68 = x3d.IS()
...
OrientationInterpolator70.key = [0,.3125,.625,1]
IS71 = x3d.IS()
...
OrientationInterpolator73.key = [0,.3125,1]
IS74 = x3d.IS()
...
OrientationInterpolator76.key = [0,.3125,.625,1]
IS77 = x3d.IS()
...
OrientationInterpolator79.key = [0,.3125,.625,1]
IS80 = x3d.IS()
...
OrientationInterpolator85.key = [0,.3125,.625,1]
IS86 = x3d.IS()
...
OrientationInterpolator88.key = [0,.3125,.625,1]
IS89 = x3d.IS()
...
OrientationInterpolator91.key = [0,.3125,.625,1]
IS92 = x3d.IS()
...
OrientationInterpolator94.key = [0,.3125,.625,1]
IS95 = x3d.IS()
...
X3D0.Scene = Scene17
f = open("LOA1_KneelAnimation_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
