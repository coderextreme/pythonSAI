...
X3D0 = X3DObject() \
   ...
   .setHead(headObject() \
    ...
    .addMeta(metaObject() \
     .setName("identifier") \
     .setContent("http://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d") \
    ) \
    .addMeta(metaObject() \
     .setName("generator") \
   ...
   .setScene(SceneObject() \
    ...
    .addChildren(TransformObject() \
     ...
     .setTranslation([0,-0.165,0.02]) \
     .addChildren(SwitchObject() \
      .setWhichChoice(-1) \
...
#Universal Media Library: Metals 30
     ...
     .addChildren(GroupObject() \
      .addChildren(TransformObject() \
       .setDEF("pCylinder1") \
       .setRotation([-1,0,0,0.373518]) \
       .setTranslation([-0.038462,3.596312,3.297562]) \
       .addChildren(ShapeObject() \
        .setAppearance(AppearanceObject() \
         .setUSE("CameraAppearance") \
        ) \
      ...
      .addChildren(TransformObject() \
       .setDEF("pCube1") \
       .setScale([1,0.727134,0.801457]) \
       .setTranslation([-0.030769,1.738461,1.4436]) \
       .addChildren(ShapeObject() \
        .setAppearance(AppearanceObject() \
         .setUSE("CameraAppearance") \
        ) \
      ...
      .addChildren(TransformObject() \
       .setDEF("pPipe1") \
       .setScale([1,1,0.569444]) \
       .setTranslation([0.015385,1.630769,-1.973274]) \
       .addChildren(ShapeObject() \
        .setAppearance(AppearanceObject() \
         .setUSE("CameraAppearance") \
        ) \
      ...
      .addChildren(TransformObject() \
       .setDEF("pSphere1") \
       .setScale([1.1,1.1,0.1]) \
       .setTranslation([-0.015385,1.628515,-2.569231]) \
       .addChildren(ShapeObject() \
        .setAppearance(AppearanceObject() \
         .setUSE("CameraAppearance") \
        ) \
...
X3D0.toFileX3D("./future/./CameraShape.newf.x3d")
