...
Transform16.setTranslation([0,0,0])
IS17 = x3d.IS()
...
Transform30.setTranslation([0,0,0])
IS31 = x3d.IS()
...
Transform72.setTranslation([0,0,0])
IS73 = x3d.IS()
