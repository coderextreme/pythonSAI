...
meta5.setContent("http://coderextreme.net/X3DJSONLD/flowers4.x3d")
...
ShaderPart27.setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"])

ComposedShader21.addParts(ShaderPart27)
ShaderPart28 = ShaderPartObject()
ShaderPart28.setType("FRAGMENT")
ShaderPart28.setUrl(["pc_bubbles.fs","http://coderextreme.net/X3DJSONLD/pc_bubbles.fs"])
