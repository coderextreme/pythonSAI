...
ComposedCubeMapTexture16 = x3dpsail.ComposedCubeMapTexture()
...
#<Sphere>
IndexedFaceSet31 = x3dpsail.IndexedFaceSet()
IndexedFaceSet31.setConvex(False)
IndexedFaceSet31.setDEF("Orbit")
Coordinate32 = x3dpsail.Coordinate()
...
X3D0.toFileX3D("././flowers4_RoundTrip.x3d")
