...
meta23.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_0.x3d"
...
HAnimJoint38.name = "HumanoidRoot"
...
HAnimJoint52.USE = "hanim_HumanoidRoot"
...
X3D0.Scene = Scene26
f = open("././DiamondManLOA_0_RoundTrip.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
