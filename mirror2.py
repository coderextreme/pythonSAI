...
field27 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader26.addField(field27)
field28 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader26.addField(field28)
field29 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader26.addField(field29)
field30 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader26.addField(field30)
field31 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader26.addField(field31)
ShaderPart32 = ShaderPartObject().setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"]).setType("VERTEX")
ComposedShader26.addParts(ShaderPart32)
ShaderPart33 = ShaderPartObject().setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"]).setType("FRAGMENT")
...
field35 = fieldObject().setName("chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader34.addField(field35)
field36 = fieldObject().setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFINT32).setValue("0")
ComposedShader34.addField(field36)
field37 = fieldObject().setName("bias").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader34.addField(field37)
field38 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0.5")
ComposedShader34.addField(field38)
field39 = fieldObject().setName("power").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("2")
ComposedShader34.addField(field39)
ShaderPart40 = ShaderPartObject().setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"]).setType("VERTEX")
ComposedShader34.addParts(ShaderPart40)
ShaderPart41 = ShaderPartObject().setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"]).setType("FRAGMENT")
