...
meta5.setContent("http://coderextreme.net/X3DJSONLD/mirro2.x3d")
...
Viewpoint8.setDescription("Switch background and cubemap texture")

Scene7.addChild(Viewpoint8)
Background9 = BackgroundObject()
Background9.setDEF("cube")
Background9.setLeftUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])
Background9.setRightUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])
Background9.setFrontUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])
Background9.setBackUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])
Background9.setTopUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])
Background9.setBottomUrl(["cubemap/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture15.setUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])
...
ImageTexture17.setUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])

ComposedCubeMapTexture14.setFront(ImageTexture17)
ImageTexture18 = ImageTextureObject()
ImageTexture18.setDEF("leftShader")
ImageTexture18.setUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])

ComposedCubeMapTexture14.setLeft(ImageTexture18)
ImageTexture19 = ImageTextureObject()
ImageTexture19.setDEF("rightShader")
ImageTexture19.setUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])

ComposedCubeMapTexture14.setRight(ImageTexture19)
ImageTexture20 = ImageTextureObject()
ImageTexture20.setDEF("topShader")
ImageTexture20.setUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])
...
ShaderPart27.setUrl(["cobweb.vs","http://coderextreme.net/X3DJSONLD/cobweb.vs"])

ComposedShader21.addParts(ShaderPart27)
ShaderPart28 = ShaderPartObject()
ShaderPart28.setType("FRAGMENT")
ShaderPart28.setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"])
...
ShaderPart35.setUrl(["x3dom.vs","http://coderextreme.net/X3DJSONLD/x3dom.vs"])

ComposedShader29.addParts(ShaderPart35)
ShaderPart36 = ShaderPartObject()
ShaderPart36.setType("FRAGMENT")
ShaderPart36.setUrl(["mix.fs","http://coderextreme.net/X3DJSONLD/mix.fs"])
