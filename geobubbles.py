...
field24 = fieldObject().setName("set_cycle").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFTIME)
Script23.addField(field24)
field25 = fieldObject().setName("val").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFFLOAT).setValue("0")
Script23.addField(field25)
field26 = fieldObject().setName("positions").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFVEC3D).setValue("0.0015708 0 4 0 0.0015708 4")
Script23.addField(field26)
field27 = fieldObject().setName("position").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFVEC3D).setValue("0.0015708 0 4 0 0.0015708 4")
