...
GeoViewpoint9 = x3dpsail.GeoViewpoint()
...
Background10 = x3dpsail.Background()
...
GeoPositionInterpolator17 = x3dpsail.GeoPositionInterpolator()
...
X3D0.toFileX3D("././geobubbles_RoundTrip.x3d")
