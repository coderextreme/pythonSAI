...
Viewpoint35 = x3dpsail.Viewpoint()
...
Viewpoint47 = x3dpsail.Viewpoint()
...
PixelTexture51 = x3dpsail.PixelTexture()
...
X3D0.toFileX3D("././Table5_18PixelTexture_RoundTrip.x3d")
