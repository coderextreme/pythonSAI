...
PositionInterpolator26 = x3dpsail.PositionInterpolator()
...
TimeSensor32 = x3dpsail.TimeSensor()
...
ProtoDeclare37 = x3dpsail.ProtoDeclare()
ProtoDeclare37.setName("cylinder")
ProtoInterface38 = x3dpsail.ProtoInterface()
...
X3D0.toFileX3D("././fors_RoundTrip.x3d")
