...
field17 = fieldObject().setName("vertex").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFSTRING).setValue("\"cobweb_flowers_chromatic.vs\"")
ExternProtoDeclare16.addField(field17)
field18 = fieldObject().setName("fragment").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFSTRING).setValue("\"common.fs\"")
...
fieldValue23 = fieldValueObject().setName("vertex").setValue("\"cobweb_flowers_chromatic.vs\"")
