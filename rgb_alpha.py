...
X3D0.setHead(head1)
Scene20 = SceneObject()
NavigationInfo21 = NavigationInfoObject().setType(["EXAMINE","WALK","FLY","ANY"])
Scene20.addChild(NavigationInfo21)
Group22 = GroupObject()
Transform23 = TransformObject().setTranslation([6.14221,0.0694613,-0.000999451])
Shape24 = ShapeObject()
Appearance25 = AppearanceObject()
Material26 = MaterialObject()
Appearance25.setMaterial(Material26)
PixelTexture27 = PixelTextureObject().setDEF("RgbOpacityCheckerboard").setImage([2,2,4,4278190335,4294901760,4294901760,4278190335])
...
Transform29 = TransformObject().setTranslation([-4.85443,0.0694381,-0.00149918])
Shape30 = ShapeObject()
Appearance31 = AppearanceObject()
Material32 = MaterialObject()
Appearance31.setMaterial(Material32)
PixelTexture33 = PixelTextureObject().setUSE("RgbOpacityCheckerboard")
...
Transform35 = TransformObject().setTranslation([-1.47341,0.036672,-0.00175095])
Shape36 = ShapeObject()
Appearance37 = AppearanceObject()
Material38 = MaterialObject()
Appearance37.setMaterial(Material38)
PixelTexture39 = PixelTextureObject().setUSE("RgbOpacityCheckerboard")
...
Transform41 = TransformObject().setTranslation([2.31094,0.0694206,-0.00187683])
Shape42 = ShapeObject()
Appearance43 = AppearanceObject()
Material44 = MaterialObject()
Appearance43.setMaterial(Material44)
PixelTexture45 = PixelTextureObject().setUSE("RgbOpacityCheckerboard")
