...
X3D0 = (x3dpsail.X3D().setProfile(x3dpsail.SFString("Immersive")).setVersion(x3dpsail.SFString("3.3"))
      .setHead(x3dpsail.head()
        ...
        .addMeta(x3dpsail.meta().setName(x3dpsail.SFString("modified")).setContent(x3dpsail.SFString("April 18 2017")))
        .addMeta(x3dpsail.meta().setName(x3dpsail.SFString("title")).setContent(x3dpsail.SFString("fors2.x3d")))
        .addMeta(x3dpsail.meta().setName(x3dpsail.SFString("identifier")).setContent(x3dpsail.SFString("https://coderextreme.net/X3DJSONLD/fors2.x3d")))
...
"					}''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("cylinder"))
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setName(x3dpsail.SFString("positionA")).setAccessType(x3dpsail.SFString("inputOnly")).setType(x3dpsail.SFString("SFVec3f")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("positionB")).setAccessType(x3dpsail.SFString("inputOnly")).setType(x3dpsail.SFString("SFVec3f"))))
          .setProtoBody(x3dpsail.ProtoBody()
            .addChild(x3dpsail.Shape()
              .setGeometry(x3dpsail.Extrusion().setDEF(x3dpsail.SFString("extrusion")).setCreaseAngle(x3dpsail.SFFloat(0.785)).setCrossSection(x3dpsail.MFVec2f([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0])).setSpine(x3dpsail.MFVec3f([0,-50,0,0,0,0,0,50,0])))
              .setAppearance(x3dpsail.Appearance()
            ...
            .addChild(x3dpsail.Script().setDEF(x3dpsail.SFString("MoveCylinder"))
              .addField(x3dpsail.field().setName(x3dpsail.SFString("spine")).setAccessType(x3dpsail.SFString("inputOutput")).setType(x3dpsail.SFString("MFVec3f")).setValue(x3dpsail.SFString("0 -50 0 0 0 0 0 50 0")))
              ...
              .setIS(x3dpsail.IS()
                .addConnect(x3dpsail.connect().setNodeField(x3dpsail.SFString("set_endA")).setProtoField(x3dpsail.SFString("positionA")))
                .addConnect(x3dpsail.connect().setNodeField(x3dpsail.SFString("set_endB")).setProtoField(x3dpsail.SFString("positionB")))).setSourceCode('''ecmascript:\n"+
"\n"+
...
"                }''')
        ...
        .addChild(x3dpsail.Transform().setScale(x3dpsail.SFVec3f(0.1,0.1,0.1))
          ...
          .addChild(x3dpsail.ProtoInstance().setName(x3dpsail.SFString("cylinder")).setDEF(x3dpsail.SFString("linkA"))
            .addFieldValue(x3dpsail.fieldValue().setName(x3dpsail.SFString("positionA")).setValue(x3dpsail.SFString("0 0 0")))
            .addFieldValue(x3dpsail.fieldValue().setName(x3dpsail.SFString("positionB")).setValue(x3dpsail.SFString("50 50 50")))))
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("nodeA")).setFromField(x3dpsail.SFString("position")).setToNode(x3dpsail.SFString("linkA")).setToField(x3dpsail.SFString("positionA")))
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("nodeB")).setFromField(x3dpsail.SFString("position")).setToNode(x3dpsail.SFString("linkA")).setToField(x3dpsail.SFString("positionB")))))

X3D0.toFileX3D("./future/./fors2_RoundTrip.x3d")
