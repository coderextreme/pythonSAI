...
Scene29.addMetadata(MetadataString34)
LayerSet35 = LayerSet()
LayerSet35.setDEF("scene.addChildLayerSetTest")

Scene29.addLayerSet(LayerSet35)
...
Scene29.addChildren(Transform36)
Shape43 = Shape()
...
Scene29.addChildren(Transform52)
...
Scene29.addChildren(ProtoDeclare78)
...
Scene29.addChildren(ExternProtoDeclare88)
...
Scene29.addChildren(ProtoDeclare107)
...
Scene29.addChildren(Shape144)

X3D0.setScene(Scene29)
X3D0.toFileX3D("././Java_RoundTrip.x3d")
