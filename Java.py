...
Scene29.children.append(WorldInfo31)
WorldInfo32 = x3d.WorldInfo()
WorldInfo32.USE = "WorldInfoDEF"

Scene29.children.append(WorldInfo32)
...
Anchor37.url = ["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"]
Shape38 = x3d.Shape()
...
ImageTexture41.url = ["images/X3dJavaSceneAccessInterfaceSaiLibrary.png","https://www.web3d.org/specifications/java/examples/images/X3dJavaSceneAccessInterfaceSaiLibrary.png"]
...
Scene29.children.append(Transform36)
Shape43 = x3d.Shape()
...
Scene29.children.append(Shape43)
...
Scene29.children.append(ROUTE50)
ROUTE51 = x3d.ROUTE()
...
Scene29.children.append(ROUTE51)
...
Scene29.children.append(ROUTE66)
ROUTE67 = x3d.ROUTE()
...
Scene29.children.append(ROUTE67)
Group68 = x3d.Group()
...
Scene29.children.append(Group68)
...
Scene29.children.append(ProtoDeclare78)
...
Scene29.children.append(Shape90)
Shape95 = x3d.Shape()
...
Scene29.children.append(Shape95)
Shape100 = x3d.Shape()
