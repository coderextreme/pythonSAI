...
"        }''')
        ...
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("G1")).setFromField(x3dpsail.SFString("translation")).setToNode(x3dpsail.SFString("connector2")).setToField(x3dpsail.SFString("set_startpoint")))
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("G3")).setFromField(x3dpsail.SFString("translation")).setToNode(x3dpsail.SFString("connector2")).setToField(x3dpsail.SFString("set_endpoint")))
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("G1")).setFromField(x3dpsail.SFString("translation")).setToNode(x3dpsail.SFString("connector3")).setToField(x3dpsail.SFString("set_startpoint")))
        .addChild(x3dpsail.ROUTE().setFromNode(x3dpsail.SFString("G4")).setFromField(x3dpsail.SFString("translation")).setToNode(x3dpsail.SFString("connector3")).setToField(x3dpsail.SFString("set_endpoint")))))

X3D0.toFileX3D("./future/./arc_RoundTrip.x3d")
