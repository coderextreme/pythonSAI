...
field37 = fieldObject().setName("startnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
Transform38 = TransformObject().setUSE("G1")
field37.addChild(Transform38)
Script36.addField(field37)
field39 = fieldObject().setName("endnode").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
Transform40 = TransformObject().setUSE("G2")
field39.addChild(Transform40)
Script36.addField(field39)
field41 = fieldObject().setName("set_startpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script36.addField(field41)
field42 = fieldObject().setName("set_endpoint").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script36.addField(field42)
field43 = fieldObject().setName("translation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
Script36.addField(field43)
field44 = fieldObject().setName("rotation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFROTATION)
Script36.addField(field44)
field45 = fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
