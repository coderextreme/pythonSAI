...
meta17 = metaObject().setName("translated").setContent("06 May 2017")
...
meta20 = metaObject().setName("translated").setContent("6 May 2017")
...
field24 = fieldObject().setName("enabled").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFBOOL)
ExternProtoDeclare23.addField(field24)
field25 = fieldObject().setName("traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFBOOL)
ExternProtoDeclare23.addField(field25)
field26 = fieldObject().setName("set_traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL)
ExternProtoDeclare23.addField(field26)
field27 = fieldObject().setName("position_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F)
ExternProtoDeclare23.addField(field27)
field28 = fieldObject().setName("orientation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFROTATION)
ExternProtoDeclare23.addField(field28)
field29 = fieldObject().setName("outputViewpointString").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFSTRING)
...
field36 = fieldObject().setName("onlyColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFCOLOR).setValue("1 0 0")
...
field43 = fieldObject().setName("children").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_MFNODE)
...
Shape60.addComments(CommentsBlock("alternative: Text string='\"\\\"\\\"\"'"))
...
PositionInterpolator79 = PositionInterpolatorObject().setDEF("StayInPlace").setKey([0,1]).setKeyValue([0,0,0,0,0,0])
Scene22.addChild(PositionInterpolator79)
ROUTE80 = ROUTEObject().setFromField("fraction_changed").setFromNode("Clock").setToField("set_fraction").setToNode("StayInPlace")
Scene22.addChild(ROUTE80)
ROUTE81 = ROUTEObject().setFromField("value_changed").setFromNode("StayInPlace").setToField("set_translation").setToNode("someInlineRoot")
Scene22.addChild(ROUTE81)
IMPORT82 = IMPORTObject().setAS("someInlineRoot").setImportedDEF("someName").setInlineDEF("someInline")
Scene22.addChild(IMPORT82)
