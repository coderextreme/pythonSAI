...
ExternProtoDeclare18 = x3dpsail.ExternProtoDeclare()
...
ProtoBody40 = x3dpsail.ProtoBody()
...
OrientationInterpolator70 = x3dpsail.OrientationInterpolator()
...
X3D0.toFileX3D("././X3dHeaderPrototypeSyntaxExamples_RoundTrip.x3d")
