...
TimeSensor21 = x3dpsail.TimeSensor()
...
PositionInterpolator31 = x3dpsail.PositionInterpolator()
...
TimeSensor37 = x3dpsail.TimeSensor()
...
X3D0.toFileX3D("././arc3_RoundTrip.x3d")
