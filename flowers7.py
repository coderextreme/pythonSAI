...
head1.addMeta(meta6)
meta7 = metaObject().setName("translated").setContent("06 May 2017")
head1.addMeta(meta7)
...
head1.addMeta(meta9)
meta10 = metaObject().setName("translated").setContent("6 May 2017")
...
field28 = fieldObject().setName("set_cube").setType(fieldObject.TYPE_SFINT32).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0")
ComposedShader27.addField(field28)
field29 = fieldObject().setName("set_chromaticDispertion").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFVEC3F).setValue("0.98 1 1.033")
ComposedShader27.addField(field29)
field30 = fieldObject().setName("set_bias").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5")
ComposedShader27.addField(field30)
field31 = fieldObject().setName("set_scale").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5")
ComposedShader27.addField(field31)
field32 = fieldObject().setName("set_power").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("2")
ComposedShader27.addField(field32)
field33 = fieldObject().setName("set_a").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("10")
ComposedShader27.addField(field33)
field34 = fieldObject().setName("set_b").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("1")
ComposedShader27.addField(field34)
field35 = fieldObject().setName("set_c").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("20")
ComposedShader27.addField(field35)
field36 = fieldObject().setName("set_d").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("20")
ComposedShader27.addField(field36)
field37 = fieldObject().setName("set_tdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0")
ComposedShader27.addField(field37)
field38 = fieldObject().setName("set_pdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0")
ComposedShader27.addField(field38)
ShaderPart39 = ShaderPartObject().setUrl(["cobweb_flowers_input.vs","http://coderextreme.net/X3DJSONLD/cobweb_flowers_input.vs"]).setType("VERTEX")
ComposedShader27.addParts(ShaderPart39)
ShaderPart40 = ShaderPartObject().setUrl(["pc_input_flowers.fs","http://coderextreme.net/X3DJSONLD/pc_input_flowers.fs"]).setType("FRAGMENT")
...
field72 = fieldObject().setName("set_fraction").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY)
Script71.addField(field72)
field73 = fieldObject().setName("a_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("10")
Script71.addField(field73)
field74 = fieldObject().setName("b_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("1")
Script71.addField(field74)
field75 = fieldObject().setName("c_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("20")
Script71.addField(field75)
field76 = fieldObject().setName("d_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("20")
Script71.addField(field76)
field77 = fieldObject().setName("tdelta_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("0")
Script71.addField(field77)
field78 = fieldObject().setName("pdelta_changed").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue("0")
Script71.addField(field78)
field79 = fieldObject().setName("set_a").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("10")
Script71.addField(field79)
field80 = fieldObject().setName("set_b").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("1")
Script71.addField(field80)
field81 = fieldObject().setName("set_c").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("20")
Script71.addField(field81)
field82 = fieldObject().setName("set_d").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("20")
Script71.addField(field82)
field83 = fieldObject().setName("set_tdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0")
Script71.addField(field83)
field84 = fieldObject().setName("set_pdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0")
