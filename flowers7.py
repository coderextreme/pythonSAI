...
ComposedCubeMapTexture17 = x3dpsail.ComposedCubeMapTexture()
...
ComposedShader24 = x3dpsail.ComposedShader()
...
ComposedCubeMapTexture40 = x3dpsail.ComposedCubeMapTexture()
...
ShaderPart51 = x3dpsail.ShaderPart()
...
ShaderPart52 = x3dpsail.ShaderPart()
...
TimeSensor77 = x3dpsail.TimeSensor()
...
X3D0.toFileX3D("././flowers7_RoundTrip.x3d")
